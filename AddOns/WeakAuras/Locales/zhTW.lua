...
L["Charged Combo Point 3"] = "充能連擊點 3"
L["Charged Combo Point 4"] = "充能連擊點 4"
L["Charged Empowered Cast"] = "已充能聚能施法"
L["Charges"] = "可用次數"
...
L["Combat Log"] = "戰鬥紀錄"
L["Condition Custom Text"] = "條件自定義文本"
L["Conditions"] = "條件"
L["Contains"] = "包含"
...
L["Custom Anchor"] = "自定義定位"
L["Custom Check"] = "自訂檢查"
L["Custom Color"] = "自訂顏色"
L["Custom Condition Code"] = "自定義條件代碼"
L["Custom Configuration"] = "自訂設定選項"
L["Custom Function"] = "自訂功能"
L["Custom Grow"] = "自訂發光"
L["Custom Sort"] = "自定義排序"
L["Custom Text Function"] = "自定義文本功能"
L["Custom Trigger Combination"] = "自定義觸發器組合"
L["Daakara"] = "達卡拉"
L["Damage"] = "傷害"
L["Damage Shield"] = "傷害盾"
...
L["Disable Spell Known Check"] = "停用已知法術檢查"
...
L["Gradient Enabled"] = "漸變已啟用"
L["Gradient Orientation"] = "漸變方向"
...
L["Minus (Small Nameplate)"] = "次要(小型血條/名條)"
L["Mirror"] = "鏡像"
L["Miss"] = "未命中"
L["Miss Type"] = "未命中類型"
L["Missed"] = "未命中"
...
L["Note: Due to how complicated the swing timer behavior is and the lack of APIs from Blizzard, results are inaccurate in edge cases."] = "注意：由於平砍計時器行為的複雜性以及暴雪缺少API，在極端情況下結果不準確。"
