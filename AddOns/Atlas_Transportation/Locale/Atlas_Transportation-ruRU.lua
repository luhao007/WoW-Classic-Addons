-- $Id: Atlas_Transportation-ruRU.lua 210 2023-03-20 15:09:13Z arithmandar $
--[[
...
L["Portal to Dreadscar Rift"] = "Портал в Разлом Зловещего Шрама"
L["Portal to Netherlight Temple"] = "Портал в Храм света Пустоты"
L["Portal to Sanctum of Light"] = "Портал в Обитель Света"
L["Portal to the Maelstrom"] = "Портал в Водоворот"
L["Portals"] = "Порталы"
L["Purple"] = "Пурпурный"
