...
function DEX_CheckButtonLink(name)
	if name == "DEX_ShowSpellName" then
		if DEX_Get(name) == 1 then
			...
			OptionsFrame_DisableCheckBox(getglobal("DEX_ShowSpellIconWithName"));			
		end
	end
	if name == "DEX_ShowSpellIcon" then
		if DEX_Get(name) == 1 then
			OptionsFrame_EnableCheckBox(getglobal("DEX_ShowSpellIconWithName"));
			DEX_RefreshCheckButton("DEX_ShowSpellIconWithName");					
		else
			OptionsFrame_DisableCheckBox(getglobal("DEX_ShowSpellIconWithName"));		
		end
	end
