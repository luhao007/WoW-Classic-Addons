local L = LibStub("AceLocale-3.0"):NewLocale("NovaRaidCompanion", "deDE");
if (not L) then
	return;
end
...
L["versionOutOfDate"] = "Dein Nova Raid Companion Addon ist nicht mehr aktuell. Bitte führe ein Update über https://www.curseforge.com/wow/addons/nova-raid-companion oder den Twitch Client durch.";
