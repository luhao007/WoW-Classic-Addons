local L = LibStub("AceLocale-3.0"):NewLocale("NovaRaidCompanion", "koKR");
if (not L) then
    return;
end
...
L["versionOutOfDate"] = "Nova Raid Companion 애드온을 트위치나 URL을 통해 업데이트 해주세요. https://www.curseforge.com/wow/addons/nova-raid-companion";
L["Options"] = "Options";
L["None"] = "None.";
L["Drink"] = "음료";
L["Food"] = "음식";
