local L = LibStub("AceLocale-3.0"):NewLocale("NovaRaidCompanion", "frFR");
if (not L) then
	return;
end
...
L["versionOutOfDate"] = "Votre addon Nova Raid Companion n'est plus à jour, mettez le à jour sur https://www.curseforge.com/wow/addons/nova-raid-companion ou via l'app twitch";
L["Options"] = "Options";
L["None"] = "None.";
L["Drink"] = "Boisson";
L["Food"] = "Nourriture";
L["Refreshment"] = "Rafraîchissement";
