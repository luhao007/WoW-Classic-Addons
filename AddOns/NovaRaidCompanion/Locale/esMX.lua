local L = LibStub("AceLocale-3.0"):NewLocale("NovaRaidCompanion", "esMX");
if (not L) then
	return;
end
...
L["versionOutOfDate"] = "Nova Raid Companion is out of date, please update at https://www.curseforge.com/wow/addons/nova-raid-companion";
L["Options"] = "Options";
L["None"] = "None";
L["Drink"] = "Beber";
L["Food"] = "Comida";
L["Refreshment"] = "Refrigerio";
