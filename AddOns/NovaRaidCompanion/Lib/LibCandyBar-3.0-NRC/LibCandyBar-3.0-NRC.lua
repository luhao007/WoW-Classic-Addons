--I've forked this (basically just added a tag to the end of the name) so my bars no longer clash with other addons like BigWigs.
--I understand there is a "key" arg that could also seperate them but I want to add glow effects and things
--and I think this is the most safe way to do it for now, just separate them.
--Thank you for the great lib, if there's any concerns about me forking this please msg me on the UI dev disc.
--Venomisto.
...
local lib = LibStub:NewLibrary("LibCandyBar-3.0-NRC", 100) -- Bump minor on changes
