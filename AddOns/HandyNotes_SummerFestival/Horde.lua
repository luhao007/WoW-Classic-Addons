...
if (SummerFestival.isClassic) then
	...
	----------------------
	points[1417] = { -- "Arathi"
		[50204499] = "11732:D",	-- Refuge Pointe
		[74174159] = "11840:H",	-- Hammerfall
	}
	points[1418] = { -- "Badlands"
		[4814890] = "11842:H",	-- New Kargath
	}
	points[1419] = { -- "BlastedLands"
		[59051703] = "11737:D",	-- Nethergarde Keep
	}
	points[1428] = { -- "BurningSteppes"
		[61932909] = "11844:H",	-- Flame Crest
		[80656253] = "11739:D",	-- Morgan's Vigil
	}
	points[1426] = { -- "DunMorogh"
		[53243515] = "9331:C",	-- Stealing Ironforge's Flame
		[46594666] = "11742:D",	-- Kharanos
	}
	...
	points[1424] = { -- "HillsbradFoothills"
		[58562488] = "11853:H",	-- Tarren Mill
		[50414724] = "11748:D",	-- South Shore
	}
	...
	points[1433] = {
		[24775914] = "11751:D",	-- Lakeshire
	}
	points[1421] = { -- "Silverpine"
		[49633820] = "11584:H",	-- The Sepulcher
	}
	points[1453] = { -- "StormwindCity"
		[38776187] = "9330:C",	-- Stealing Stormwind's Flame
	}
	points[1435] = {	--Swamp
		[46954749] = "11857:H",	-- Bogpaddle (west)
	}
	points[1434] = { --STV
		[32907528] = "11837:H",	-- Wild Shore (south)
		[33867344] = "11761:D",	-- Wild Shore (north)
	}
	points[1420] = {
	...
	points[1440] = { -- "Ashenvale"
		[70106920] = "11841:H",	-- Silverwind Refuge
		[37835486] = "11734:D",	-- Astranaar
	}
	...
	points[1444] = { -- "Feralas"
		[28244390] = "11746:D",	-- Feathermoon Stronghold
	...
	points[1451] = { -- "Silithus"
		[46444465] = "11836:H",	-- Cenarion Hold (south)
		[57613506] = "11760:D",	-- Cenarion Hold (east)
	}
	points[1442] = { -- "StonetalonMountains"
		[50516041] = "11856:H",	-- Sun Rock Retreat
	}
	points[1446] = { -- "Tanaris"
		[49852702] = "11838:H",	-- Gadgetzan (west)
		[52752927] = "11762:D",	-- Gadgetzan (east)
	}
	points[1438] = { -- "Teldrassil"
		[56619236] = "9332:C",	-- Stealing Darnassus' Flame
		[54976042] = "11753:D",	-- Dolanaar
	}
	points[1947] = { -- "TheExodar"
		[41242570] = "11933:C",	-- Stealing the Exodar's Flame
	}
	points[1441] = { -- "Thousand Needles"
		[42375295] = "11861:H", -- Freewind post
	}
	points[1452] = { -- "Winterspring"
		[59853554] = "11839:H",	-- Everlook (west)
		[62623541] = "11763:D",	-- Everlook (east)
	}
...
elseif (SummerFestival.isCata) then
	...
	points[1413] = { -- "Barrens"
		[50015461] = "11859:H",	-- The Crossroads
	}
	points[1950] = { -- "BloodmystIsle"
		[55866852] = "11738:D",	-- Blood Watch
	}
	...
	points[1451] = { -- "Silithus"
		[50794124] = "11836:H",	-- Cenarion Hold (south)
		[60413303] = "11760:D",	-- Cenarion Hold (east)
	}
	points[199] = { -- "South Barrens"
		[40816773] = "28927:H", -- Desolation Hold
		[48307234] = "28913:D",	-- Fort Triumph
	}
	points[1442] = { -- "StonetalonMountains"
	...
	points[1446] = { -- "Tanaris"
		[49792790] = "11838:H",	-- Gadgetzan (west)
		[52693017] = "11762:D",	-- Gadgetzan (east)
	}
	points[1438] = { -- "Teldrassil"
		[54765269] = "11753:D",	-- Dolanaar
	}
	points[1457] = { -- "Darnassus"
		[63764648] = "9332:C",	-- Stealing Darnassus' Flame
	}
	points[1947] = { -- "TheExodar"
		[41242570] = "11933:C",	-- Stealing the Exodar's Flame
	}
