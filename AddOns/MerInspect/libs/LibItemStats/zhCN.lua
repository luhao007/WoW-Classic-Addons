...
LibItemStatsPatterns = {
	...
	general = {
		...
		{ key = "ResistanceFrost|ResistanceShadow|ResistanceArcane|ResistanceFire|ResistanceNature|ResistanceHoly", pattern = "所有魔法抗性" },
		...
		{ key = "SpellHitRating",     pattern = "法术命中" },
		{ key = "SpellCrit", pattern = "法术致命一击" },
		{ key = "Healing", pattern = "法术治疗" },
		{ key = "Healing", pattern = "治疗法术" },
		{ key = "Healing",     pattern = "治疗" },
		{ key = "Dodge", pattern = "躲闪" },
		{ key = "Parry", pattern = "招架" },
		{ key = "Defense", pattern = "防御" },
		{ key = "HitRating", pattern = "命中" },
		{ key = "RangedAttackPower", pattern = "远程攻击强度" },		
		{ key = "AttackCrit|RangedAttackCrit", pattern = "致命一击" },		
		{ key = "AttackPower|RangedAttackPower", pattern = "攻击强度" },
		{ key = "Block", pattern = "格挡" },
	},
	extra = {
		{ key = "Armor", pattern = "(%d+)点护甲$" },
		{ key = "Block", pattern = "(%d+)格挡$" },
		{ key = "ManaRestore", pattern = "每5秒恢复(%d+)点法力值" },
		{ key = "ManaRestore", pattern = "每5秒回复(%d+)点法力值" },
		{ key = "Resilience", pattern = "韧性等级提高(%d+)" },
		{ key = "SpellHitRating", pattern = "使你的法术击中敌人的几率提高(%d+)%%" },
		{ key = "HasteSpell", pattern = "法术急速等级提高(%d+)" },
		{ key = "SpellCrit", pattern = "使你的法术造成致命一击的几率提高(%d+)%%" },
		{ key = "SpellCrit|AttackCrit", pattern = "使你造成爆击的几率提高(%d+)%%" },
		{ key = "SpellCrit", pattern = "使你的法术造成爆击的几率提高(%d+)%%" },
		{ key = "SpellStrike", pattern = "法术穿透提高(%d+)" },		
		{ key = "SpellDamage|Healing", pattern = "[提]*高所有法术和魔法效果所造成的伤害和治疗效果，最多(%d+)点", },
		{ key = "SpellDamage|Healing", pattern = "提高法术和魔法效果所造成的治疗效果，最多(%d+)点", },
		{ key = "Healing", pattern = "提高法术和魔法效果所造成的治疗效果，最多(%d+)", },
		{ key = "Healing", pattern = "使法术的治疗效果提高最多(%d+)点", },
		{ key = "Healing", pattern = "使治疗法术和效果所回复的生命值提高(%d+)点", },
		{ key = "Healing", pattern = "提高法术所造成的治疗效果，最多(%d+)点", },
		{ key = "DamageFrost", pattern = "提高冰霜法术和效果所造成的伤害，最多(%d+)点" },
		{ key = "DamageShadow", pattern = "提高暗影法术和效果所造成的伤害，最多(%d+)点" },
		{ key = "DamageArcane", pattern = "提高奥术法术和效果所造成的伤害，最多(%d+)点" },
		{ key = "DamageFire", pattern = "提高火焰法术和效果所造成的伤害，最多(%d+)点" },
		{ key = "DamageNature", pattern = "提高自然法术和效果所造成的伤害，最多(%d+)点" },
		{ key = "DamageHoly", pattern = "提高神圣法术和效果所造成的伤害，最多(%d+)点" },
		{ key = "HasteMelee", pattern = "急速等级提高(%d+)" },
		{ key = "RangedAttackPower", pattern = "%+(%d+) 远程攻击强度" },		
		{ key = "AttackCrit|RangedAttackCrit", pattern = "使你造成致命一击的几率提高(%d+)%%" },		
		{ key = "AttackPower|RangedAttackPower", pattern = "%+(%d+) 攻击强度" },
		{ key = "HitRating", pattern = "使你击中目标的几率提高(%d+)%%" },
		{ key = "Parry", pattern = "使你招架攻击的几率提高(%d+)%%" },
		{ key = "Defense", pattern = "防御技能提高(%d+)点" },
		{ key = "Dodge", pattern = "使你躲闪攻击的几率提高(%d+)%%" },
		{ key = "Block", pattern = "盾牌格挡值提高(%d+)" },
		{ key = "Block", pattern = "^(%d+)点格挡" },
		{ key = "Block", pattern = "使你的盾牌的格挡值提高(%d+)点" },
		{ key = "ReduceResistance", pattern = "使你的法术目标的魔法抗性降低(%d+)点。" },
		{ key = "SpellHitRating", pattern = "使你的法术击中敌人的几率提高(%d+)%%" },
		{ key = "SpellCrit", pattern = "使你的法术造成爆击的几率提高(%d+)%%" },
		{ key = "RangedAttackPower", pattern = "%+(%d+) 远程攻击强度" },		
		{ key = "AttackCrit|RangedAttackCrit", pattern = "使你造成爆击的几率提高(%d+)%%" },		
		{ key = "AttackPower|RangedAttackPower", pattern = "%+(%d+) 攻击强度" },
    ...
    buff = {
		...
		{ key = "ResistanceFrost|ResistanceShadow|ResistanceArcane|ResistanceFire|ResistanceNature|ResistanceHoly", pattern = "%+(%d+) 所有魔法抗性",},
		...
		{ key = "SpellDamage", pattern = "治疗和法术伤害 %+(%d+)$",},
