--[[
	...
	Revision: $Id: BeanCounterLocale.lua 6422 2019-09-22 00:20:05Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterLocale.lua $","$Rev: 6422 $","5.1.DEV.", 'auctioneer', 'libs')
