--[[
	...
	Revision: $Id: BeanCounterUpdate.lua 6434 2019-10-20 00:10:07Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterUpdate.lua $","$Rev: 6434 $","5.1.DEV.", 'auctioneer', 'libs')
