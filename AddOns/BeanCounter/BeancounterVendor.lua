--[[
	...
	Revision: $Id: BeancounterVendor.lua 6422 2019-09-13 05:07:31Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeancounterVendor.lua $","$Rev: 6422 $","5.1.DEV.", 'auctioneer', 'libs')
