...
Inst4Quest5_Aim = "Viaja a la Cumbre de Roca Negra y destruye al general Drakkisath. Reegresa con el mariscal Maxwell cuando el trabajo esté listo."
...
Inst4Quest6_HORDE_Note = "Es la misión para la armonización con Onyxia. Encuentras al Jefe de Guerra Rend Puño Negro en "..YELLOW.."[6]"..WHITE.."."
...
Inst14Quest1_Aim = "Consigue 20 muestras de carne apestada de Stratholme y llévaselas Betina Bigglezink. Tienes la sospecha de que podrás obtener ese tipo de carne de cualquier criatura de Stratholme."
