...
Inst2Quest2_Note = "Highlord Bolvar Fordragon is at (Stormwind City - Stormwind Keep; "..YELLOW.."78.0, 18.0"..WHITE.."). The follow up sends you to Field Marshal Stonebridge (Stormwind - Valley of Heroes; "..YELLOW.."66.9, 72.38"..WHITE..") for the reward."
...
Inst3Quest1_Note = "You find the tablets near Shadow Hunter Vosh'gajin at "..YELLOW.."[7]"..WHITE.." and War Master Voone at "..YELLOW.."[9]"..WHITE..".\nThe rewards come from the follow up quest.  The quest line starts with Yeh'kinya at Tanaris ("..YELLOW.."67.0, 22.4"..WHITE..")."
...
Inst3Quest2_Note = "You find the Worg Pup near Halcyon at "..YELLOW.."[17]"..WHITE.."."
...
Inst3Quest3_Note = "You find the spider eggs near Mother Smolderweb at "..YELLOW.."[13]"..WHITE.."."
...
Inst3Quest7_Location = "Bijou (Blackrock Spire; "..YELLOW.."[8]"..WHITE..")"
...
Inst3Quest14_Location = "Human Remains (Lower Blackrock Spire; "..YELLOW.."[11]"..WHITE..")"
Inst3Quest14_Note = "Blacksmith quest.  Be sure to pick up the Unfired Plate Gauntlets near the Human Remains at "..YELLOW.."[11]"..WHITE..". Turns in to Malyfous Darkhammer (Winterspring - Everlook; "..YELLOW.."61.0, 38.6"..WHITE..").  The rewards listed are for the followup quest."
...
Inst3Quest10_HORDE_Note = "Onyxia attunement questline.  You find Highlord Omokk at "..YELLOW.."[5]"..WHITE..", War Master Voone at "..YELLOW.."[9]"..WHITE.." and Overlord Wyrmthalak at "..YELLOW.."[19]"..WHITE..".  The Blackrock Documents appear next to one of these 3 bosses."
...
Inst4Quest9_Note = "Dungeon Armor set questline.  Extra-Dimensional Ghost Revealer is needed to see Bodley.  You get it from the 'In Search of Anthion' quest.  Lord Valthalak is summoned at "..YELLOW.."[8]"..WHITE..".  The rewards listed are for the follow up quest."
...
Inst4Quest12_Note = "This the last quest for Onyxia attunement.  More information about how to start the quest line is in the Blackrock Depths quest 'Marshal Windsor'.  You find General Drakkisath at "..YELLOW.."[9]"..WHITE.."."
...
Inst4Quest6_HORDE_Note = "Onyxia attunement questline.  You find Warchief Rend Blackhand at "..YELLOW.."[6]"..WHITE.."."
...
--Quest 4 Alliance
Inst14Quest4 = "4. The Great Ezra Grimm"
Inst14Quest4_Aim = "Find Ezra Grimm's smoke shop in Stratholme and recover a box of Grimm's Premium Tobacco. Return to Smokey LaRue when the job is done."
Inst14Quest4_Location = "Smokey LaRue (Eastern Plaguelands - Light's Hope Chapel; "..YELLOW.."80.6, 58.0"..WHITE..")"
Inst14Quest4_Note = "You find the smoke shop near "..YELLOW.."[1]"..WHITE..".  Ezra Grimm spawns when you open box."
...
--Quest 16 Alliance
Inst20Quest16 = "16. Nostro's Compendium"
Inst20Quest16_Aim = "Return Nostro's Compendium of Dragon Slaying to the Athenaeum."
Inst20Quest16_Location = "Nostro's Compendium of Dragon Slaying (random boss drop in "..YELLOW.."Dire Maul"..WHITE..")"
...
Inst28Quest1_Prequest = "Nostro's Compendium ("..YELLOW.."Dire Maul West"..WHITE..") -> The Forging of Quel'Serrar"
...
Inst33Quest10_Note = "Reportedly you do not need to do anything but be near a graveyard when the Horde assaults it. It does not need to be captured, just assaulted."
