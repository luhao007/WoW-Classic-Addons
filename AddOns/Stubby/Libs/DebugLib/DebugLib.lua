--[[
	...
	Version: 8.2.6339 (SwimmingSeadragon)
	Revision: $Id: DebugLib.lua 6339 2019-09-22 00:20:05Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/DebugLib/DebugLib.lua $","$Rev: 6339 $","5.1.DEV.", 'auctioneer', 'libs')
