...
do --简体说明书
    ns.instructionsText = {
        "|cff00BFFF< 说明书 >（本插件支持WLK、60服，不再支持CTM、探索赛季）",
        " ",
        ...
        [[-拍卖WA更新为v2.5：拍卖金额超过1万时会进行缩写。ALT+点击折叠时，会对全部拍卖窗口折叠]],
        [[-拍卖成功的聊天消息后面增加[出价记录] ]],
        [[-角色总览：增加选项"不显示低于该装等的角色"]],
        [[-表格设置：增加选项"进本自动清空时不保存表格"]],
        [[-<WLK>团员成就：统计里增加"工程技能点""获得小宠物数量"]],
        [[-<WLK>时光徽章：增加换算比例]],
        " ",
        "|cff00FF00" .. [[3月13日更新v1.15.4]],
        [[-支持订阅模块新功能：在角色总览查看每个角色装备]],
        " ",
        "|cff00FF00" .. [[3月9日更新v1.15.3]],
        [[-当别人通报账单后，在聊天框增加一个快捷复制账单按钮]],
        [[-对账：在对账界面增加显示当前对账单的团员名单]],
        [[-YY链接现在会根据你的评价进行着色]],
        [[-修复了错误提示版本号过期的问题]],
        [[-<60>MC杂项格子增加到15个]],
        " ",
    ...
    ns.VIPinstructionsText = {
        ...
        "提前设定每个装备的自动拍卖起拍价，ALT+右键点击表格/背包/聊天框装备时，直接按预设价开拍。",
        ...
        "功能入口在表格左上角的拍卖记录，右键点击拍卖成功的装备。",
        "|cffFFFFFF" .. "<WLK>TBC表格：",
        "可以提前使用太阳井、黑暗神殿等表格，方便你开团刷幻化。",
        " ",
    ...
    ns.AccountsinstructionsText = {
        ...
        " ",
        "|cffFFFFFF该模块由BiaoGe数据同步软件生成。",
        "BiaoGe的角色总览可以显示全账号角色。",
        "BiaoGeVIP的历史表格汇总可以汇总全账号数据。",
        " ",
        "|cff00ff00点击查看在线文档（图文介绍）",
    }
end
...
do
    ...
    L["你的BiaoGe插件存在问题，请删除本地插件再重新安装一次。"] = true
    L["团员名单"] = true
    L["< 交易记账成功 >|r\n装备：%s\n买家：%s\n金额：%s%d|rg%s\nBoss：%s%s|r"] = true
