...
GTFO.SpellID["69845"] = {
	--desc = "Frost Bomb (Sindragosa - 10)";
	sound = 3;
};

GTFO.SpellID["71053"] = {
	--desc = "Frost Bomb (Sindragosa - 25)";
	sound = 3;
};

GTFO.SpellID["71054"] = {
	--desc = "Frost Bomb (Sindragosa - 10H)";
	sound = 3;
};

GTFO.SpellID["71055"] = {
	--desc = "Frost Bomb (Sindragosa - 25H)";
	sound = 3;
};
...
GTFO.SpellID["72038"] = {
	--desc = "Empowered Shock Vortex FF (Prince Valanar, ICC 10)";
	sound = 3;
};

GTFO.SpellID["72815"] = {
	--desc = "Empowered Shock Vortex FF (Prince Valanar, ICC 25)";
	sound = 3;
};

GTFO.SpellID["72816"] = {
	--desc = "Empowered Shock Vortex FF (Prince Valanar, ICC 10H)";
	sound = 3;
};

GTFO.SpellID["72817"] = {
	--desc = "Empowered Shock Vortex FF (Prince Valanar, ICC 25H)";
	sound = 3;
};

GTFO.SpellID["63801"] = {
	--desc = "Bomb Bot (Ulduar 25)";
	sound = 3;
};

GTFO.SpellID["64626"] = {
	--desc = "Frost Bomb Explosion (Mimiron, Ulduar 10)";
	sound = 3;
};

GTFO.SpellID["65333"] = {
	--desc = "Frost Bomb Explosion (Mimiron, Ulduar 25)";
	sound = 3;
};

GTFO.SpellID["47944"] = {
	--desc = "Crystal Spike (Ormorok the Tree Shaper, Nexus)";
	sound = 3;
};

GTFO.SpellID["57067"] = {
	--desc = "Crystal Spike (Ormorok the Tree Shaper, Nexus Heroic)";
	sound = 3;
};

GTFO.SpellID["53454"] = {
	--desc = "Impale (Anub'arak, Azjol-Nerub)";
	sound = 3;
};

GTFO.SpellID["59446"] = {
	--desc = "Impale (Anub'arak, Azjol-Nerub Heroic)";
	sound = 3;
};

GTFO.SpellID["53472"] = {
	--desc = "Pound (Anub'arak, Azjol-Nerub)";
	sound = 3;
};

GTFO.SpellID["59433"] = {
	--desc = "Pound (Anub'arak, Azjol-Nerub Heroic)";
	sound = 3;
};

GTFO.SpellID["52960"] = {
	--desc = "Lightning Nova (Loken, Halls of Lightning)";
	sound = 3;
};

GTFO.SpellID["59835"] = {
	--desc = "Lightning Nova (Loken, Halls of Lightning Heroic)";
	sound = 3;
};
...
GTFO.SpellID["68867"] = {
	--desc = "Tail Sweep (Onyxia 10)";
	sound = 3;
};

GTFO.SpellID["69286"] = {
	--desc = "Tail Sweep (Onyxia 25)";
	sound = 3;
};

GTFO.SpellID["71021"] = {
	--desc = "Saber Lash (Deathbound Ward - ICC)";
	sound = 3;
};

GTFO.SpellID["55697"] = {
	--desc = "Tail Sweep (Sapphiron - Naxx 10)";
	sound = 3;
};

GTFO.SpellID["55696"] = {
	--desc = "Tail Sweep (Sapphiron - Naxx 25)";
	sound = 3;
};

GTFO.SpellID["28157"] = {
	--desc = "Slime Spray (Grobbulus - Naxx 10)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["54364"] = {
	--desc = "Slime Spray (Grobbulus - Naxx 25)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["50155"] = {
	--desc = "Tail Sweep (Keristrasza - Nexus)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["48096"] = {
	--desc = "Crystalfire Breath (Keristrasza - Nexus)";
	sound = 3;
	tankSound = 0;
	applicationOnly = true;
};
...
GTFO.SpellID["42669"] = {
	--desc = "Smash (Ingvar the Plunderer - Utgarde Keep)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["59706"] = {
	--desc = "Smash (Ingvar the Plunderer - Utgarde Keep Heroic)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["56908"] = {
	--desc = "Flame Breath (Sartharion - Obsidian Sanctum 10)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["58956"] = {
	--desc = "Flame Breath (Sartharion - Obsidian Sanctum 25)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["56909"] = {
	--desc = "Cleave (Sartharion - Obsidian Sanctum)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["56910"] = {
	--desc = "Tail Lash (Sartharion - Obsidian Sanctum 10)";
	sound = 3;
};

GTFO.SpellID["58957"] = {
	--desc = "Tail Lash (Sartharion - Obsidian Sanctum 25)";
	sound = 3;
};

GTFO.SpellID["57570"] = {
	--desc = "Shadow Breath (Drakes - Obsidian Sanctum 10)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["59126"] = {
	--desc = "Shadow Breath (Drakes - Obsidian Sanctum 25)";
	sound = 3;
	tankSound = 0;
};

GTFO.SpellID["39189"] = {
	--desc = "Explosion (Lich King - ICC 10H)";
	sound = 3;
};
