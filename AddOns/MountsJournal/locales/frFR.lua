...
L["ButtonsSelectedTooltipDescription"] = "Les boutons sur le côté sélectionnent les montures par type à invoquer suivant les conditions. Les favoris n'affectent pas les montures d'invocation utilisant %s."
