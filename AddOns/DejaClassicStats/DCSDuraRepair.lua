...
local DCSITEM_SLOT_FRAMES = {
	...
	CharacterWaistSlot, CharacterLegsSlot, CharacterFeetSlot, CharacterWristSlot, CharacterHandsSlot, CharacterFinger0Slot,
...
local QCOA_Slider = CreateFrame("Slider", "QCOA_Slider", DejaClassicStatsPanel, "OptionsSliderTemplate")
	...
	QCOA_Slider.tooltipText = "Set the intensity (alpha) of your equipped items' quality colored border glow in increments or decrements of 5. Default is 75."
...
local DCS_ShowDuraCheck = CreateFrame("CheckButton", "DCS_ShowDuraCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ShowDuraCheck.tooltipText = L["Displays each equipped item's durability."]
...
local DCS_ShowDuraTextureCheck = CreateFrame("CheckButton", "DCS_ShowDuraTextureCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ShowDuraTextureCheck.tooltipText = L["Displays a durability bar next to each item."]
...
local DCS_ShowAverageDuraCheck = CreateFrame("CheckButton", "DCS_ShowAverageDuraCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ShowAverageDuraCheck.tooltipText = L["Displays average item durability on the character shirt slot and durability frames."]
...
local DCS_ShowItemRepairCheck = CreateFrame("CheckButton", "DCS_ShowItemRepairCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ShowItemRepairCheck.tooltipText = L["Displays each equipped item's repair cost."]
...
--[[Reordered DCSITEM_SLOT_FRAMES frame names to match the constants index order
	so we can use k as the slotId so we dont have to make another table with
	the constants names to iterate through or otherwise refactor the code.]]
	for k, v in ipairs(DCSITEM_SLOT_FRAMES) do
		...
		if item:IsItemEmpty() then
			...
			item:ContinueOnItemLoad(function()
				...
				local colorTbl = item:GetItemQualityColor()
				local currentItemLevel = C_Item.GetCurrentItemLevel(itemLoc)
				v.ilevel:SetTextColor(colorTbl.r, colorTbl.g, colorTbl.b)
				v.ilevel:SetText(currentItemLevel)
			end)
		end
	end
end
...
local DCS_ShowItemLevelCheck = CreateFrame("CheckButton", "DCS_ShowItemLevelCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ShowItemLevelCheck.tooltipText = L["Displays the item level of each equipped item. Caveat; Item level is relatively meaningless in Classic."]
...
local DCS_SimpleItemColorCheck = CreateFrame("CheckButton", "DCS_SimpleItemColorCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_SimpleItemColorCheck.tooltipText = L["Black item icons to make text more visible."]
...
local DCS_DarkerItemColorCheck = CreateFrame("CheckButton", "DCS_DarkerItemColorCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_DarkerItemColorCheck.tooltipText = L["Darken item icons to make text more visible."]
...
local DCS_ENCHANT_IDS = {
	...
	[2752] = "+3 Critical Strike Rating &\n+3 Strength",
	[2753] = "+4 Critical Strike Rating &\n+4 Strength",
	[2754] = "+8 Parry Rating",
	[2755] = "+3 Hit Rating &\n+3 Agility",
	[2756] = "+4 Hit Rating &\n+4 Agility",
	[2757] = "+3 Critical Strike Rating &\n+4 Stamina",
	[2758] = "+4 Critical Strike Rating &\n+6 Stamina",
	[2759] = "+8 Resilience Rating",
	[2760] = "+3 Critical Strike Rating &\n+4 Spell Power",
	[2761] = "+4 Critical Strike Rating &\n+5 Spell Power",
	[2762] = "+3 Critical Strike Rating &\n+4 Spell Penetration",
	[2763] = "+4 Critical Strike Rating &\n+5 Spell Penetration",
	[2764] = "+8 Hit Rating",
	...
	[2985] = "+8 Fire Resist",
	[2986] = "+30 Attack Power &\n+10 Critical Strike Rating",
	[2987] = "+8 Frost Resist",
	[2988] = "+8 Nature Resist",
	[2989] = "+8 Arcane Resist",
	[2990] = "+13 Defense Rating",
	[2991] = "+15 Defense Rating &\n+10 Dodge Rating",
	[2992] = "+6 Mana Regen",
	[2993] = "+12 Spell Power &\n8 Mana every 5 seconds",
	[2994] = "+13 Critical Strike Rating",
	[2995] = "+15 Critical Strike Rating &\n+12 Spell Power",
	[2996] = "+13 Critical Strike Rating",
	[2997] = "+15 Critical Strike Rating &\n+20 Attack Power",
	[2998] = "+7 All Resistances",
	[2999] = "+16 Defense Rating &\n+17 Dodge Rating",
	[3000] = "+18 Stamina, +12 Dodge Rating, &\n+12 Resilience Rating",
	[3001] = "+19 Spell Power &\n+9 Mana every 5 seconds",
	[3002] = "+22 Spell Power &\n+14 Hit Rating",
	[3003] = "+34 Attack Power &\n+16 Hit Rating",
	...
	[3010] = "+40 Attack Power &\n+10 Critical Strike Rating",
	[3011] = "+30 Stamina &\n+10 Agility",
	[3012] = "+50 Attack Power &\n+12 Critical Strike Rating",
	[3013] = "+40 Stamina &\n+12 Agility",
	...
	[3048] = "+5 Agility &\n+6 Stamina",
	[3049] = "+5 Critical Strike Rating &\n+2 mana per 5 sec.",
	[3050] = "+6 Spell Power &\n+4 Intellect",
	[3051] = "+6 Spell Power &\n+6 Stamina",
	[3052] = "+10 Attack Power &\n+4 Hit Rating",
	[3053] = "+5 Defense Rating &\n+4 Dodge Rating",
	[3054] = "+6 Spell Power &\n+6 Stamina",
	[3055] = "+5 Agility &\n+4 Hit Rating",
	[3056] = "+5 Parry Rating &\n+4 Defense Rating",
	[3057] = "+5 Strength &\n+4 Hit Rating",
	[3058] = "+5 Critical Strike Rating &\n+2 mana per 5 sec",
	[3059] = "+5 Critical Strike Rating &\n2 mana per 5 sec.",
	[3060] = "+5 Dodge Rating &\n+6 Stamina",
	[3061] = "+5 Hit Rating &\n+6 Spell Power",
	[3062] = "+6 Critical Strike Rating &\n+5 Dodge Rating",
	[3063] = "+5 Parry Rating &\n+6 Stamina",
	[3064] = "+5 Spirit &\n+5 Spell Power",
	[3065] = "+8 Strength",
	[3066] = "+6 Spell Power &\n+5 Spell Penetration",
	[3067] = "+10 Attack Power &\n+6 Stamina",
	[3068] = "+5 Dodge Rating &\n+4 Hit Rating",
	[3069] = "+6 Spell Power &\n+4 Resilience Rating",
	[3070] = "+8 Attack Power &\n+5 Critical Strike Rating",
	[3071] = "+5 Intellect &\n+6 Stamina",
	...
	[3074] = "+4 Intellect &\n+5 Spirit",
	[3075] = "+5 Strength &\n+4 Defense Rating",
	[3076] = "+4 Critical Strike Rating &\n+6 Spell Power",
	[3077] = "+5 Intellect &\n2 mana per 5 sec.",
	[3078] = "+6 Stamina &\n+5 Defense Rating",
	[3079] = "+8 Attack Power &\n+5 Resilience Rating",
	[3080] = "+6 Stamina &\n+5 Resilience Rating",
	[3081] = "+6 Spell Power &\n+4 Critical Strike Rating",
	[3082] = "+5 Defense Rating &\n2 mana per 5 sec.",
	[3083] = "+6 Spell Power &\n+4 Spirit",
	[3084] = "+5 Dodge Rating &\n+4 Resilience Rating",
	[3085] = "+6 Stamina &\n+5 Critical Strike Rating",
	[3086] = "+6 Spell Power &\n2 mana per 5 sec.",
	...
	[3110] = "+3 Hit Rating &\n+4 Spell Power",
	[3111] = "+4 Hit Rating &\n+5 Spell Power",
	[3112] = "+4 Critical Strike Rating &\n+8 Attack Power",
	[3113] = "+3 Critical Strike Rating &\n+6 Attack Power",
	[3114] = "+4 Attack Power",
	[3115] = "+10 Strength",
	[3116] = "+10 Agility",
	[3117] = "+12 Spell Power",
	...
	[3133] = "+5 Strength &\n+7 Stamina",
	[3134] = "+5 Agility &\n+7 Stamina",
	[3135] = "+10 Attack Power &\n+7 Stamina",
	[3136] = "+10 Attack Power &\n+3 Mana every 5 Seconds",
	[3137] = "+6 Spell Power &\n+7 Stamina",
	[3138] = "+6 Spell Power &\n+3 Mana every 5 seconds",
	[3139] = "+5 Critical Strike Rating &\n+5 Strength",
	[3140] = "+5 Critical Strike Rating &\n+6 Spell Power",
	[3141] = "+6 Spell Power &\n+5 Intellect",
	[3142] = "+5 Hit Rating &\n+5 Agility",
	[3143] = "+5 Hit Rating &\n+6 Spell Power",
	[3144] = "+5 Critical Strike Rating &\n+10 Attack Power",
	[3145] = "+5 Defense Rating &\n+7 Stamina",
	[3146] = "+5 Critical Strike Rating &\n+6 Spell Penetration",
	[3147] = "+5 Intellect &\n+3 Mana every 5 seconds",
	[3148] = "+5 Critical Strike Rating &\n+7 Stamina",
	[3149] = "+2 Agility",
	...
	[3254] = "+4 All Stats",
	[3255] = "+55 Spell Power",
	[3256] = "Increased Stealth &\n+10 Agility",
	[3257] = "+54 Spell Power",
	[3258] = "+18 Spell Power",
	[3259] = "+22 Stamina",
	[3260] = "+240 Armor",
	[3261] = "+12 Critical Strike Rating &\n3% Increased Critical Damage",
	[3262] = "+15 Stamina",
	...
	[3272] = "+4 Haste Rating &\n+6 Stamina",
	[3273] = "Deathfrost",
	[3274] = "+12 Defense Rating &\n+5% Shield Block Value",
	[3275] = "+14 Spell Power &\n+2% Intellect",
...
--[[ *********************************************
	...
	*********************************************]]
	...
	[3391] = "+6 Armor Penetration Rating &\n+9 Stamina",
	[3392] = "+6 Strength &\n+9 Stamina",
	[3393] = "+6 Agility &\n+9 Stamina",
	[3394] = "+7 Spell Power &\n+9 Stamina",
	[3395] = "+12 Attack Power &\n+9 Stamina",
	[3396] = "+6 Dodge Rating &\n+9 Stamina",
	[3397] = "+6 Parry Rating &\n+9 Stamina",
	[3398] = "+6 Expertise Rating &\n+9 Stamina",
	[3399] = "+7 Spell Power &\n+6 Spirit",
	[3400] = "+6 Agility &\n+3 Mana every 5 seconds",
	[3401] = "+7 Spell Power &\n+3 Mana every 5 seconds",
	[3402] = "+12 Attack Power &\n+3 Mana every 5 seconds",
	[3403] = "+7 Spell Power &\n+8 Spell Penetration",
	[3404] = "+7 Spell Power &\n+6 Intellect",
	...
	[3418] = "+6 Dodge Rating &\n+6 Defense Rating",
	[3419] = "+6 Parry Rating &\n+6 Defense Rating",
	[3420] = "+6 Expertise Rating &\n+6 Hit Rating",
	[3421] = "+6 Expertise Rating &\n+6 Defense Rating",
	[3422] = "+12 Attack Power &\n+6 Critical Strike Rating",
	[3423] = "+12 Attack Power &\n+6 Hit Rating",
	[3424] = "+12 Attack Power &\n+6 Resilience Rating",
	[3426] = "+12 Attack Power &\n+6 Haste Rating",
	[3427] = "+6 Intellect &\n+9 Stamina",
	[3428] = "+6 Critical Strike Rating &\n+9 Stamina",
	[3429] = "+6 Hit Rating &\n+9 Stamina",
	[3430] = "+6 Defense Rating &\n+9 Stamina",
	[3431] = "+6 Resilience Rating &\n+9 Stamina",
	[3432] = "+6 Haste Rating &\n+9 Stamina",
	[3433] = "+6 Intellect &\n+6 Spirit",
	[3434] = "+6 Critical Strike Rating &\n+6 Spirit",
	[3435] = "+6 Hit Rating &\n+6 Spirit",
	[3436] = "+6 Resilience Rating &\n+6 Spirit",
	[3437] = "+6 Haste Rating &\n+6 Spirit",
	[3438] = "+6 Intellect &\n+3 Mana every 5 seconds",
	[3439] = "+6 Critical Strike Rating &\n+3 Mana every 5 seconds",
	[3440] = "+6 Hit Rating &\n+3 Mana every 5 seconds",
	[3441] = "+6 Resilience Rating &\n+3 Mana every 5 seconds",
	[3442] = "+6 Haste Rating &\n+3 Mana every 5 seconds",
	[3443] = "+6 Critical Strike Rating &\n+8 Spell Penetration",
	[3444] = "+6 Hit Rating &\n+8 Spell Penetration",
	[3445] = "+6 Haste Rating &\n+8 Spell Penetration",
	[3446] = "+16 Strength",
	[3447] = "+16 Agility",
	...
	[3465] = "+8 Agility &\n+12 Stamina",
	[3466] = "+9 Spell Power &\n+12 Stamina",
	[3467] = "+16 Attack Power &\n+12 Stamina",
	[3468] = "+8 Dodge Rating &\n+12 Stamina",
	[3469] = "+8 Parry Rating &\n+12 Stamina ",
	[3470] = "+8 Armor Penetration Rating &\n+12 Stamina",
	[3471] = "+8 Expertise Rating &\n+12 Stamina",
	[3472] = "+9 Spell Power &\n+8 Spirit",
	[3473] = "+9 Spell Power &\n+4 Mana every 5 seconds",
	[3474] = "+8 Agility &\n+4 Mana every 5 seconds",
	[3475] = "+16 Attack Power &\n+4 Mana every 5 seconds",
	...
	[3489] = "+9 Spell Power &\n+8 Resilience Rating",
	[3490] = "+9 Spell Power &\n+8 Haste Rating",
	[3491] = "+16 Attack Power &\n+8 Critical Strike Rating",
	[3492] = "+16 Attack Power &\n+8 Hit Rating",
	[3493] = "+16 Attack Power &\n+8 Resilience Rating",
	[3494] = "+16 Attack Power &\n+8 Haste Rating",
	[3495] = "+8 Dodge Rating &\n+8 Defense Rating",
	[3496] = "+8 Parry Rating &\n+8 Defense Rating",
	[3497] = "+8 Expertise Rating &\n+8 Hit Rating",
	[3498] = "+8 Expertise Rating &\n+8 Defense Rating",
	[3499] = "+8 Intellect &\n+12 Stamina",
	[3500] = "+8 Critical Strike Rating &\n+12 Stamina",
	[3501] = "+8 Hit Rating &\n+12 Stamina",
	[3502] = "+8 Defense Rating &\n+12 Stamina",
	[3503] = "+8 Resilience Rating &\n+12 Stamina",
	[3504] = "+8 Haste Rating &\n+12 Stamina",
	[3505] = "+8 Intellect &\n+8 Spirit",
	[3506] = "+8 Critical Strike Rating &\n+8 Spirit",
	[3507] = "+8 Hit Rating &\n+8 Spirit",
	[3508] = "+8 Resilience Rating &\n+8 Spirit",
	[3509] = "+8 Haste Rating &\n+8 Spirit",
	[3510] = "+8 Intellect &\n+4 Mana every 5 seconds",
	[3511] = "+8 Critical Strike Rating &\n+4 Mana every 5 seconds",
	[3512] = "+8 Hit Rating &\n+4 Mana every 5 seconds",
	[3513] = "+8 Resilience Rating &\n+4 Mana every 5 seconds",
	[3514] = "+8 Haste Rating &\n+4 Mana every 5 seconds",
	[3515] = "+8 Critical Strike Rating &\n+10 Spell Penetration",
	[3516] = "+8 Hit Rating &\n+10 Spell Penetration",
	[3517] = "+8 Haste Rating &\n+10 Spell Penetration",
	[3518] = "+20 Strength",
	[3519] = "+20 Agility",
	...
	[3537] = "+10 Agility &\n+15 Stamina",
	[3538] = "+12 Spell Power &\n+15 Stamina",
	[3539] = "+20 Attack Power &\n+15 Stamina",
	[3540] = "+10 Dodge Rating &\n+15 Stamina",
	[3541] = "+10 Parry Rating &\n+15 Stamina",
	[3542] = "+10 Expertise Rating &\n+15 Stamina",
	[3543] = "+10 Armor Penetration Rating &\n+15 Stamina",
	[3544] = "+10 Agility &\n+5 Mana every 5 seconds",
	[3545] = "+12 Spell Power &\n+10 Spirit",
	[3546] = "+12 Spell Power &\n+5 Mana every 5 seconds",
	[3547] = "+20 Attack Power &\n+5 Mana every 5 seconds",
	...
	[3561] = "+12 Spell Power &\n+10 Resilience Rating",
	[3563] = "+12 Spell Power &\n+10 Haste Rating",
	[3564] = "+20 Attack Power &\n+10 Critical Strike Rating",
	[3565] = "+20 Attack Power &\n+10 Hit Rating",
	[3566] = "+20 Attack Power &\n+10 Resilience Rating",
	[3567] = "+20 Attack Power &\n+10 Haste Rating",
	[3568] = "+10 Dodge Rating &\n+10 Defense Rating",
	[3569] = "+10 Parry Rating &\n+10 Defense Rating",
	[3570] = "+10 Expertise Rating &\n+10 Hit Rating",
	[3571] = "+10 Expertise Rating &\n+10 Defense Rating",
	[3572] = "+10 Intellect &\n+15 Stamina",
	[3573] = "+10 Critical Strike Rating &\n+15 Stamina",
	[3574] = "+10 Hit Rating &\n+15 Stamina",
	[3575] = "+10 Defense Rating &\n+15 Stamina",
	[3576] = "+10 Resilience Rating &\n+15 Stamina",
	[3577] = "+10 Haste Rating &\n+15 Stamina",
	[3578] = "+10 Intellect &\n+10 Spirit",
	[3579] = "+10 Critical Strike Rating &\n+10 Spirit",
	[3580] = "+10 Hit Rating &\n+10 Spirit",
	[3581] = "+10 Resilience Rating &\n+10 Spirit",
	[3582] = "+10 Haste Rating &\n+10 Spirit",
	[3583] = "+10 Intellect &\n+5 Mana every 5 seconds",
	[3584] = "+10 Critical Strike Rating &\n+5 Mana every 5 seconds",
	[3585] = "+10 Hit Rating &\n+5 Mana every 5 seconds",
	[3586] = "+10 Resilience Rating &\n+5 Mana every 5 seconds",
	[3587] = "+10 Haste Rating &\n+5 Mana every 5 seconds",
	[3588] = "+10 Critical Strike Rating &\n+13 Spell Penetration",
	[3589] = "+10 Hit Rating &\n+13 Spell Penetration",
	[3590] = "+10 Haste Rating &\n+13 Spell Penetration",
	[3591] = "Test +4 Intellect &\n+2 Mana every 5 seconds",
	...
	[3621] = "+21 Critical Strike Rating &\n3% Increased Critical Damage",
	[3622] = "+25 Critical Strike Rating &\n1% Spell Reflect",
	[3623] = "+25 Spell Power &\n+2% Intellect",
	[3624] = "+21 Critical Strike Rating &\nReduces Snare/Root Duration by 10%",
	[3625] = "+42 Attack Power &\nMinor Run Speed Increase",
	[3626] = "+25 Spell Power &\n2% Reduced Threat",
	[3627] = "+21 Intellect &\nChance to restore mana on spellcast",
	[3628] = "+21 Agility &\n3% Increased Critical Damage",
	[3630] = "+21 Defense Rating &\nChance to Restore Health on hit",
	[3631] = "+21 Defense Rating &\n+5% Shield Block Value",
	[3632] = "+25 Spell Power &\nMinor Run Speed Increase",
	[3633] = "+11 Mana every 5 seconds &\n3% Increased Critical Healing Effect",
	[3634] = "+32 Stamina &\nReduce Spell Damage Taken by 2%",
	[3635] = "+25 Spell Power &\nSilence Duration Reduced by 10%",
	[3636] = "+21 Critical Strike Rating &\nFear Duration Reduced by 10%",
	[3637] = "+32 Stamina &\n2% Increased Armor Value from Items",
	[3638] = "+42 Attack Power &\nStun Duration Reduced by 10%",
	[3639] = "+25 Spell Power &\nStun Duration Reduced by 10%",
	[3640] = "+42 Attack Power &\nSometimes Heal on Your Crits",
	[3641] = "+21 Critical Strike Rating &\n+2% Mana",
	[3642] = "+32 Stamina &\nStun Duration Reduced by 10%",
	...
	[3663] = "+14 Attack Power &\n+4 Mana every 5 seconds",
	[3664] = "+14 Attack Power &\n+11 Stamina",
	[3665] = "+7 Armor Penetration Rating &\n+11 Stamina",
	[3666] = "+7 Agility &\n+4 Mana every 5 seconds",
	[3667] = "+7 Agility &\n+11 Stamina",
	[3668] = "+7 Dodge Rating &\n+11 Stamina",
	[3669] = "+7 Expertise Rating &\n+11 Stamina",
	[3670] = "+7 Parry Rating &\n+11 Stamina",
	[3671] = "+7 Strength &\n+11 Stamina",
	[3672] = "+8 Spell Power &\n+4 Mana every 5 seconds",
	[3673] = "+8 Spell Power &\n+7 Spirit",
	[3674] = "+8 Spell Power &\n+9 Spell Penetration",
	[3675] = "+8 Spell Power &\n+11 Stamina",
	[3676] = "+14 Attack Power &\n+7 Critical Strike Rating (OLD)",
	[3677] = "+7 Agility &\n+7 Haste Rating",
	[3678] = "+14 Attack Power &\n+7 Haste Rating",
	[3679] = "+14 Attack Power &\n+7 Hit Rating",
	[3680] = "+14 Attack Power &\n+7 Resilience Rating",
	...
	[3694] = "+7 Dodge Rating &\n+7 Defense Rating",
	[3695] = "+7 Parry Rating &\n+7 Defense Rating",
	[3696] = "+7 Expertise Rating &\n+7 Hit Rating",
	[3697] = "+7 Expertise Rating &\n+7 Defense Rating",
	[3698] = "+7 Critical Strike Rating &\n+7 Spirit",
	[3699] = "+7 Critical Strike Rating &\n+11 Stamina",
	[3700] = "+7 Defense Rating &\n+11 Stamina",
	[3701] = "+7 Haste Rating &\n+7 Spirit",
	[3702] = "+7 Haste Rating &\n+11 Stamina",
	[3703] = "+7 Hit Rating &\n+7 Spirit",
	[3704] = "+7 Hit Rating &\n+11 Stamina",
	[3705] = "+7 Intellect &\n+7 Spirit",
	[3706] = "+7 Intellect &\n+11 Stamina",
	[3707] = "+7 Resilience Rating &\n+7 Spirit",
	[3708] = "+7 Resilience Rating &\n+11 Stamina",
	[3709] = "+7 Critical Strike Rating &\n+9 Spell Penetration",
	[3710] = "+7 Critical Strike Rating &\n+4 Mana every 5 seconds",
	[3711] = "+7 Intellect &\n+4 Mana every 5 seconds",
	[3712] = "+7 Hit Rating &\n+4 Mana every 5 seconds",
	[3713] = "+7 Resilience Rating &\n+4 Mana every 5 seconds",
	[3714] = "+7 Haste Rating &\n+4 Mana every 5 seconds",
	[3715] = "+7 Hit Rating &\n+9 Spell Penetration",
	[3716] = "+7 Haste Rating &\n+9 Spell Penetration",
	[3717] = "Socket Bracer",
	...
	[3793] = "+40 Attack Power &\n+15 Resilience Rating",
	[3794] = "+23 Spell Power &\n+15 Resilience Rating",
	[3795] = "+50 Attack Power &\n+20 Resilience Rating",
	[3796] = "+29 Spell Power &\n+20 Resilience Rating",
	[3797] = "+29 Spell Power &\n+20 Resilience Rating",
	[3798] = "+34 Attack Power &\nMinor Run Speed Increase",
	[3799] = "+20 Spell Power &\nMinor Run Speed Increase",
	[3800] = "+17 Critical Strike Rating &\nFear Duration Reduced by 10%",
	[3801] = "+17 Critical Strike Rating &\nReduces Snare/Root Duration by 10%",
	[3802] = "+20 Spell Power &\nSilence Duration Reduced by 10%",
	[3803] = "+34 Attack Power &\nStun Duration Reduced by 10%",
	[3804] = "+26 Stamina &\nStun Duration Reduced by 10%",
	[3805] = "+20 Spell Power &\nStun Duration Reduced by 10%",
	[3806] = "+18 Spell Power &\n+10 Critical Strike Rating",
	[3807] = "+18 Spell Power &\n+5 Mana per 5 sec",
	[3808] = "+40 Attack Power &\n+15 Crit Rating",
	[3809] = "+24 Spell Power &\n+8 Mana per 5 sec",
	[3810] = "+24 Spell Power &\n+15 Critical Strike Rating",
	[3811] = "+20 Dodge Rating &\n+15 Defense Rating",
	[3812] = "+25 Frost Resistance &\n+30 Stamina",
	[3813] = "+25 Nature Resistance &\n+30 Stamina",
	[3814] = "+25 Shadow Resistance &\n+30 Stamina",
	[3815] = "+25 Arcane Resistance &\n+30 Stamina",
	[3816] = "+25 Fire Resistance &\n+30 Stamina",
	[3817] = "+50 Attack Power &\n+20 Critical Strike Rating",
	[3818] = "+37 Stamina &\n+20 Defense Rating",
	[3819] = "+30 Spell Power &\n10 mana per 5 seconds.",
	[3820] = "+30 Spell Power &\n20 Critical strike rating.",
	[3821] = "+8 Resilience Rating",
	[3822] = "+55 Stamina &\n+22 Agility",
	[3823] = "+75 Attack Power &\n+22 Critical Strike Rating",
	...
	[3834] = "+63 Spell Power",
	[3835] = "+120 Attack Power &\n+15 Crit Rating",
	[3836] = "+70 Spell Power &\n+6 Mana/5 seconds",
	[3837] = "+60 Dodge Rating &\n+15 Defense Rating",
	[3838] = "+70 Spell Power &\n+15 Crit Rating",
	[3839] = "+40 Attack Power",
	[3840] = "+23 Spell Power",
	[3841] = "+23 Spell Power",
	[3842] = "+30 Stamina &\n+25 Resilience Rating",
	...
	[3875] = "+30 Attack Power &\n+10 Critical Strike Rating",
	[3876] = "+15 Dodge Rating &\n+10 Defense Rating",
...
--[[ *********************************************
	...
	*********************************************]]
	[3599] = "Electromagnetic Pulse Generator", -- Personal Electromagnetic Pulse Generator
	...
	[3605] = "+23 Agility", -- Flexweave Underlay
	[3606] = "+24 Critical Strike Rating", -- Nitro Boosts
	[3859] = "+27 Spell Power", -- Springy Arachnoweave
...
--[[ *********************************************
				Engineering Enchants
	*********************************************]]
	[3599] = "EMPG", -- Personal Electromagnetic Pulse Generator
	[3601] = "Frag Belt", -- Frag Belt
	[3603] = "HMPR", --  Hand-Mounted Pyro Rocket
	[3604] = "HS-XL8R", -- Hyperspeed Accelerator
	[3605] = "+23 Agi", -- Flexweave Underlay
	[3606] = "+24 Crit Rt", -- Nitro Boosts
	[3859] = "+27 SP", -- Springy Arachnoweave
	[3860] = "+885 AC", -- Reticulated Armor Webbing
	[3878] = "+45 Stam", -- Mind Amplification Dish
}
...
local function DCS_Item_Enchant_GetText()
	...
	for _, v in ipairs(DCSITEM_SLOT_FRAMES) do
		...
		if itemLink then
			...
			if showenchant then
				v.enchant:SetTextColor(r, g, b, 1)
...
DCS_AbbrevEnchantsCheck:ClearAllPoints()
	...
	DCS_AbbrevEnchantsCheck.tooltipText = L["Displays an abbreviated label of each equipped item's enchantment."]
...
local DCS_AlternateInfoPlacementCheck = CreateFrame("CheckButton", "DCS_AlternateInfoPlacementCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_AlternateInfoPlacementCheck.tooltipText = L["Displays the item's info beside each item's slot."]
...
local DCS_ItemQualityBordersCheck = CreateFrame("CheckButton", "DCS_ItemQualityBordersCheck", DejaClassicStatsPanel, "InterfaceOptionsCheckButtonTemplate")
	...
	DCS_ItemQualityBordersCheck.tooltipText = L["Displays a colored border around each item's slot indicating its quality."]
