...
----------------------------------------------------
L[" melee and ranged damage."] = "Nahkampf- und Fernkampfschaden"
...
L["+ Nature: "] = "+ Natur: "
L["+ Shadow: "] = "+ Schatten: "
L["Abbreviated Enchant Labels"] = "Verkürzte Verzauberungsbezeichnungen"
...
L["Default Resistances"] = "Standardresistenzen"
L["Default Stats"] = "Standardwerte"
L["Defense: "] = "Verteidigung: "
L["Display Info Beside Items"] = "Zeige Info neben Gegenstand an"
L["Displays a colored border around each item's slot indicating its quality."] = "Zeigt einen farbigen Rahmen entsprechend der Qualität um einen Gegenstandsplatz."
L["Displays an abbreviated label of each equipped item's enchantment."] = "Zeigt verkürzte Bezeichnungen für Verzauberungen angelegter Gegenstände."
...
L["Displays the Character Model Rotation buttons."] = "Zeigt die Knöpfe, um das Charaktermodell zu drehen."
L["Displays the class talents background art."] = "Zeige Klassentalenthintergrund an."
L["Displays the default resistance frames."] = "Zeigt den Rahmen für Standardresistenzen."
L["Displays the default stat frames."] = "Zeigt den Rahmen für Standardwerte."
L["Displays the Expand button above the hands item slot."] = "Zeigt den Erweitern-Button über dem Gegenstandsplatz der Hände an."
L["Displays the item level of each equipped item. Caveat; Item level is relatively meaningless in Classic."] = "Zeigt die Gegenstandsstufe angelegter Ausrüstung. Caveat; in Classic ist die Gegenstandsstufe relativ bedeutungslos."
...
L["Gives a chance to block enemy melee and ranged attacks."] = "Erhöht die Chance gegnerische Nah- und Fernkampfangriffe zu blocken."
L["Gives a chance to critically strike with melee attacks, increasing the damage dealt by 100%."] = "Erhöht die Chance auf kritische Treffer durch Nahkampfangriffe, Schaden wird um 100% erhöht."
L["Gives a chance to critically strike with spells, increasing the damage dealt by 50%."] = "Erhöht die Chance auf kritische Treffer durch Zauber, Schaden wird um 50% erhöht."
...
L["Item Quality Borders"] = "Qualitätsrahmen für Gegenstände"
L["Item Quality Glow"] = "Leuchten des Qualitätsrahmens"
L["Main Hand Damage: "] = "Schaden Waffenhand: "
L["Main Hand: "] = "Waffenhand: "
L["Mana points regenerated every five seconds while casting and inside the five second rule."] = "Manaregeneration alle 5 Sekunden, während gezaubert wird."
L["Mana points regenerated every tick while casting and inside the five second rule."] = "Manaregeneration alle 5 Sekunden, während gezaubert wird."
L["Mana Regen Current: "] = "Mana Regen aktuell: "
...
L["Ranged Damage: "] = "Fernk. Schaden: "
L["Ranged Hit: "] = "Fernk. Treff.: "
L["Ranged: "] = "Fernkampf: "
L["Repair Total: "] = "Reparatur gesamt: "
L["Rotation Buttons"] = "Knöpfe zum Drehen"
L["Set the intensity (alpha) of your equipped items' quality colored border glow in increments or decrements of 5. Default is 75."] = "Regelt die Intensität (Transparenz) des Leuchtens der Qualitätrahmen angelegter Gegenstände in 5er Schritten. Standard ist 75."
L["Show Character Frame"] = "Öffnet die Charakteranzeige"
L["Show defense stats."] = "Zeigt Verteidigungswerte."
L["Show melee stats."] = "Zeigt Nahkampfwerte."
L["Show primary stats."] = "Zeigt die primären Werte."
L["Show spell stats."] = "Zeigt Zauberwerte."
...
L["Total Mana points regenerated per tick while not casting and outside the five second rule."] = "Gesamte Manaregeneration alle 5 Sekunden, während nicht gezaubert wird und außerhalb des Kampfes."
L["Your blocks mitigate "] = "Deine Blockwertung "
