...
L["Gives a chance to critically stike with melee attacks, increasing the damage dealt by 100%."] = "Erhöht die Chance auf kritische Treffer durch Nahkampfangriffe, Schaden wird um 100% erhöht."
...
L["Gives a chance to critically stike with spells, increasing the damage dealt by 50%."] = "Erhöht die Chance auf kritische Treffer durch Zauber, Schaden wird um 50% erhöht."
