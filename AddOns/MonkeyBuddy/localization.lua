...
MONKEYBUDDY_RESET_TO_BLIZZARD_STYLE			= "Blizzard Style";
...
MONKEYBUDDY_QUEST_COLOURSUBOBJECTIVES		= "Colour objectives by progress";
MONKEYBUDDY_QUEST_ITEMSENABLED				= "Show quest item buttons (Tainted in 6.0.3)"
MONKEYBUDDY_QUEST_ITEMSONLEFT				= "Show quest items on left side";
MONKEYBUDDY_QUEST_HIDEHEADER				= "Only show title/titlebuttons on mouseover"
MONKEYBUDDY_QUEST_HIDEQUESTSENABLED			= "Hide quests via right click if not showing hidden items"
MONKEYBUDDY_QUEST_COLOURDONEORFAILED		= "Colour finished or failed quest titles"
MONKEYBUDDY_QUEST_QUESTTEXTTOOLTIP			= "Show full quest text on mouse over"
...
MONKEYBUDDY_QUEST_HIGHLIGHTALPHASLIDER		= "Zone Highlight Alpha";
...
MONKEYBUDDY_QUEST_FONT						= "Schriftart:";
...
MONKEYBUDDY_QUEST_HIGHLIGHTALPHASLIDER		= "Questzonen-Hervorhebung Alpha"
...
MONKEYBUDDY_QUEST_FONT						= "La police:";
...
-- English, the default
MONKEYBUDDY_DESCRIPTION						= "幫助你對MonkeyMods進行設定";
MONKEYBUDDY_LOADED_MSG						= MONKEYBUDDY_INFO_COLOUR .. MONKEYBUDDY_TITLE .. " v" .. MONKEYBUDDY_VERSION .. " 載入";

MONKEYBUDDY_TOOLTIP_CLOSE					= "關閉";
MONKEYBUDDY_RESET_ALL						= "全部重設";
MONKEYBUDDY_RESET_TO_BLIZZARD_STYLE			= "暴雪風格";
MONKEYBUDDY_RESET							= "重設";

MONKEYBUDDY_GUI_TEXT						="這個插件是幫助你對MonkeyMods（猴子插件模組）進行設定的工具"
MONKEYBUDDY_GUI_MBLOADED					= MONKEYBUDDY_GUI_ICON .. "MonkeyBuddy成功載入！"
MONKEYBUDDY_GUI_MMINSTALLED					="啟用的MonkeyMods："
MONKEYBUDDY_GUI_MBMINIMAP					="顯示MonkeyBuddy的小地圖圖示"
MONKEYBUDDY_GUI_MQEXTRA						="MonkeyQuest額外功能："
MONKEYBUDDY_GUI_MQEDAILY					="在大標題顯示每日任務的計數器"
MONKEYBUDDY_GUI_MBOPENCFG					="點擊按鈕開啟"

-- defs for MonkeyQuest
MONKEYBUDDY_QUEST_OPEN						= "開啟MonkeyQuest";
MONKEYBUDDY_QUEST_SHOWHIDDEN				= "顯示所有隱藏的項目";
MONKEYBUDDY_QUEST_USEOVERVIEWS				= "沒有具體的任務目標時，顯示任務概述";
MONKEYBUDDY_QUEST_HIDEHEADERS				= "不顯示隱藏的項目時，一併隱藏區域標題";
MONKEYBUDDY_QUEST_ALWAYSHEADERS				= "總是顯示區域標題";
MONKEYBUDDY_QUEST_HIDEBORDER				= "隱藏邊框";
MONKEYBUDDY_QUEST_GROWUP					= "向上展開";
MONKEYBUDDY_QUEST_SHOWNUMQUESTS				= "顯示任務數量";
MONKEYBUDDY_QUEST_LOCK						= "鎖定MonkeyQuest視窗";
MONKEYBUDDY_QUEST_COLOURTITLEON				= "根據難度著色任務標題";
MONKEYBUDDY_QUEST_HIDECOMPLETEDQUESTS		= "隱藏已完成任務";
MONKEYBUDDY_QUEST_HIDECOMPLETEDOBJECTIVES	= "隱藏已完成目標";
MONKEYBUDDY_QUEST_SHOWTOOLTIPOBJECTIVES		= "在滑鼠提示中顯示目標進度";
MONKEYBUDDY_QUEST_ALLOWRIGHTCLICK			= "右鍵點擊視窗開啟MonkeyBuddy";
MONKEYBUDDY_QUEST_HIDETITLEBUTTONS			= "隱藏主標題按鈕";
MONKEYBUDDY_QUEST_HIDETITLE					= "隱藏主標題的「" .. MONKEYBUDDY_QUEST_TITLE .. "」文字";
MONKEYBUDDY_QUEST_FONT						= "字型：";
MONKEYBUDDY_QUEST_CRASHBORDER				= "使用金色邊框";
MONKEYBUDDY_QUEST_SHOWNOOBTIPS				= "顯示新手提示";
MONKEYBUDDY_QUEST_SHOWZONEHIGHLIGHT			= "顯示任務區域高亮";
MONKEYBUDDY_QUEST_SHOWQUESTLEVEL			= "顯示任務等級";
MONKEYBUDDY_QUEST_WORKCOMPLETE				= "啟用「任務完成」的音效";
MONKEYBUDDY_QUEST_COLOURSUBOBJECTIVES		= "根據進度著色任務目標";
MONKEYBUDDY_QUEST_ITEMSENABLED				= "顯示任務物品按鈕（6.0.3後會汙染暴雪元素）"
MONKEYBUDDY_QUEST_ITEMSONLEFT				= "將任務物品顯示在左側";
MONKEYBUDDY_QUEST_HIDEHEADER				= "只在滑鼠指向時顯示大標題和和大標題按鈕"
MONKEYBUDDY_QUEST_HIDEQUESTSENABLED			= "右鍵點擊任務隱藏；只在未勾選「顯示所有隱藏的項目」時生效"
MONKEYBUDDY_QUEST_COLOURDONEORFAILED		= "著色已完成或失敗的任務標題"
MONKEYBUDDY_QUEST_QUESTTEXTTOOLTIP			= "滑鼠指向時，顯示完整的任務文本"

MONKEYBUDDY_QUEST_QUESTTITLECOLOUR			= "任務標題";
MONKEYBUDDY_QUEST_HEADEROPENCOLOUR			= "展開的區域標題";
MONKEYBUDDY_QUEST_HEADERCLOSEDCOLOUR		= "折疊的區域標題";
MONKEYBUDDY_QUEST_OVERVIEWCOLOUR			= "任務概述";
MONKEYBUDDY_QUEST_SPECIALOBJECTIVECOLOUR	= "特殊目標";
MONKEYBUDDY_QUEST_INITIALOBJECTIVECOLOUR	= "目標進度0%";
MONKEYBUDDY_QUEST_MIDOBJECTIVECOLOUR		= "目標進度50%以下";
MONKEYBUDDY_QUEST_COMPLETEOBJECTIVECOLOUR	= "目標進度50%以上";
MONKEYBUDDY_QUEST_FINISHOBJECTIVECOLOUR		= "完成的目標";
MONKEYBUDDY_QUEST_ZONEHIGHLIGHTCOLOUR		= "高亮目前區域";

MONKEYBUDDY_QUEST_FRAMEALPHASLIDER			= "全局透明度";
MONKEYBUDDY_QUEST_ALPHASLIDER				= "背景透明度";
MONKEYBUDDY_QUEST_HIGHLIGHTALPHASLIDER		= "區域高亮透明度";
MONKEYBUDDY_QUEST_WIDTHSLIDER				= "視窗寬度";
MONKEYBUDDY_QUEST_FONTSLIDER				= "字型大小";
MONKEYBUDDY_QUEST_PADDINGSLIDER				= "任務間距";

-- defs for MonkeySpeed
MONKEYBUDDY_SPEED_OPEN						= "開啟MonkeySpeed";
MONKEYBUDDY_SPEED_PERCENT					= "以百分比顯示速度";
MONKEYBUDDY_SPEED_BAR						= "Show speed as a background colour";
MONKEYBUDDY_SPEED_LOCK						= "鎖定MonkeySpeed視窗";
MONKEYBUDDY_SPEED_ALLOWRIGHTCLICK			= "允許右鍵點擊開啟MonkeyBuddy";

MONKEYBUDDY_SPEED_WIDTHSLIDER				= "視窗寬度";
MONKEYBUDDY_SPEED_HEIGHTSLIDER				= "視窗高度";

-- defs for MonkeyClock
MONKEYBUDDY_CLOCK_OPEN						= "開啟MonkeyClock";
MONKEYBUDDY_CLOCK_HIDEBORDER				= "隱藏邊框";
MONKEYBUDDY_CLOCK_USEMILITARYTIME			= "使用24小時制";
MONKEYBUDDY_CLOCK_LOCK						= "Lock the MonkeyClock frame";
MONKEYBUDDY_CLOCK_CHATALARM					= "Use the alarm message in the chat window";
MONKEYBUDDY_CLOCK_DIALOGALARM				= "Use the alarm dialog box with snooze button";
MONKEYBUDDY_CLOCK_ALLOWRIGHTCLICK			= "Allow right click to open MonkeyBuddy";
...
-- bindings
BINDING_NAME_MONKEYBUDDY_OPEN				= "開啟控制台";

elseif (GetLocale() == "zhCN") then

-- English, the default
MONKEYBUDDY_DESCRIPTION						= "帮助你对MonkeyMods进行配置";
MONKEYBUDDY_LOADED_MSG						= MONKEYBUDDY_INFO_COLOUR .. MONKEYBUDDY_TITLE .. " v" .. MONKEYBUDDY_VERSION .. " 已加载";

MONKEYBUDDY_TOOLTIP_CLOSE					= "关闭";
MONKEYBUDDY_RESET_ALL						= "全部重设";
MONKEYBUDDY_RESET_TO_BLIZZARD_STYLE			= "暴雪风格";
MONKEYBUDDY_RESET							= "重设";

MONKEYBUDDY_GUI_TEXT						="这个插件是帮助你对MonkeyMods进行配置的工具"
MONKEYBUDDY_GUI_MBLOADED					= MONKEYBUDDY_GUI_ICON .. "MonkeyBuddy成功加载！"
MONKEYBUDDY_GUI_MMINSTALLED					="启用的MonkeyMods："
MONKEYBUDDY_GUI_MBMINIMAP					="显示MonkeyBuddy的小地图图标"
MONKEYBUDDY_GUI_MQEXTRA						="MonkeyQuest额外功能："
MONKEYBUDDY_GUI_MQEDAILY					="在大标题显示日常任务计数器"
MONKEYBUDDY_GUI_MBOPENCFG					="点击按钮开启"

-- defs for MonkeyQuest
MONKEYBUDDY_QUEST_OPEN						= "开启MonkeyQuest";
MONKEYBUDDY_QUEST_SHOWHIDDEN				= "显示所有隐藏的项目";
MONKEYBUDDY_QUEST_USEOVERVIEWS				= "没有具体的任务目标时，显示任务概述";
MONKEYBUDDY_QUEST_HIDEHEADERS				= "不显示隐藏的项目时，一并隐藏区域标题";
MONKEYBUDDY_QUEST_ALWAYSHEADERS				= "总是显示区域标题";
MONKEYBUDDY_QUEST_HIDEBORDER				= "隐藏边框";
MONKEYBUDDY_QUEST_GROWUP					= "向上展开";
MONKEYBUDDY_QUEST_SHOWNUMQUESTS				= "显示任务数量";
MONKEYBUDDY_QUEST_LOCK						= "锁定MonkeyQuest";
MONKEYBUDDY_QUEST_COLOURTITLEON				= "根据难度着色任务标题";
MONKEYBUDDY_QUEST_HIDECOMPLETEDQUESTS		= "隐藏已完成任务";
MONKEYBUDDY_QUEST_HIDECOMPLETEDOBJECTIVES	= "隐藏已完成目标";
MONKEYBUDDY_QUEST_SHOWTOOLTIPOBJECTIVES		= "在鼠标提示中显示目标进度";
MONKEYBUDDY_QUEST_ALLOWRIGHTCLICK			= "右键点击开启MonkeyBuddy";
MONKEYBUDDY_QUEST_HIDETITLEBUTTONS			= "隐藏主标题按钮";
MONKEYBUDDY_QUEST_HIDETITLE					= "隐藏主标题的“" .. MONKEYBUDDY_QUEST_TITLE .. "”文字";
MONKEYBUDDY_QUEST_FONT						= "字型：";
MONKEYBUDDY_QUEST_CRASHBORDER				= "使用金色边框";
MONKEYBUDDY_QUEST_SHOWNOOBTIPS				= "显示新手提示";
MONKEYBUDDY_QUEST_SHOWZONEHIGHLIGHT			= "显示任务区域高亮";
MONKEYBUDDY_QUEST_SHOWQUESTLEVEL			= "显示任务等级";
MONKEYBUDDY_QUEST_WORKCOMPLETE				= "启用“任务完成”的音效";
MONKEYBUDDY_QUEST_COLOURSUBOBJECTIVES		= "根据进度着色任务目标";
MONKEYBUDDY_QUEST_ITEMSENABLED				= "显示任务物品按钮（6.0.3后会污染暴雪元素）"
MONKEYBUDDY_QUEST_ITEMSONLEFT				= "将任务物品显示在左侧";
MONKEYBUDDY_QUEST_HIDEHEADER				= "只在鼠标指向时显示大标题和和大标题按钮"
MONKEYBUDDY_QUEST_HIDEQUESTSENABLED			= "右键点击任务隐藏；只在未勾选“显示所有隐藏的项目”时生效"
MONKEYBUDDY_QUEST_COLOURDONEORFAILED		= "着色已完成或失败的任务标题"
MONKEYBUDDY_QUEST_QUESTTEXTTOOLTIP			= "鼠标指向时，显示完整的任务文本"

MONKEYBUDDY_QUEST_QUESTTITLECOLOUR			= "任务标题";
MONKEYBUDDY_QUEST_HEADEROPENCOLOUR			= "展开的区域标题";
MONKEYBUDDY_QUEST_HEADERCLOSEDCOLOUR		= "折叠的区域标题";
MONKEYBUDDY_QUEST_OVERVIEWCOLOUR			= "任务概述";
MONKEYBUDDY_QUEST_SPECIALOBJECTIVECOLOUR	= "特殊目标";
MONKEYBUDDY_QUEST_INITIALOBJECTIVECOLOUR	= "目标进度0%";
MONKEYBUDDY_QUEST_MIDOBJECTIVECOLOUR		= "目标进度50%以下";
MONKEYBUDDY_QUEST_COMPLETEOBJECTIVECOLOUR	= "目标进度50%以上";
MONKEYBUDDY_QUEST_FINISHOBJECTIVECOLOUR		= "完成的目标";
MONKEYBUDDY_QUEST_ZONEHIGHLIGHTCOLOUR		= "高亮目前区域";

MONKEYBUDDY_QUEST_FRAMEALPHASLIDER			= "全局透明度";
MONKEYBUDDY_QUEST_ALPHASLIDER				= "背景透明度";
MONKEYBUDDY_QUEST_HIGHLIGHTALPHASLIDER		= "区域高亮透明度";
MONKEYBUDDY_QUEST_WIDTHSLIDER				= "窗口宽度";
MONKEYBUDDY_QUEST_FONTSLIDER				= "字号";
MONKEYBUDDY_QUEST_PADDINGSLIDER				= "任务间距";

-- defs for MonkeySpeed
MONKEYBUDDY_SPEED_OPEN						= "启用MonkeySpeed";
MONKEYBUDDY_SPEED_PERCENT					= "显示百分比";
MONKEYBUDDY_SPEED_BAR						= "以移动速度染色背景";
MONKEYBUDDY_SPEED_LOCK						= "锁定MonkeySpeed视窗";
MONKEYBUDDY_SPEED_ALLOWRIGHTCLICK			= "右键点击开启MonkeyBuddy";

MONKEYBUDDY_SPEED_WIDTHSLIDER				= "视窗宽度";
MONKEYBUDDY_SPEED_HEIGHTSLIDER				= "视窗高度";

-- defs for MonkeyClock
MONKEYBUDDY_CLOCK_OPEN						= "启用MonkeyClock";
MONKEYBUDDY_CLOCK_HIDEBORDER				= "隐藏边框";
MONKEYBUDDY_CLOCK_USEMILITARYTIME			= "使用24小时制";
MONKEYBUDDY_CLOCK_LOCK						= "锁定窗口";
MONKEYBUDDY_CLOCK_CHATALARM					= "在聊天框提醒闹钟响了";
MONKEYBUDDY_CLOCK_DIALOGALARM				= "U弹出对话框提醒闹钟响了";
MONKEYBUDDY_CLOCK_ALLOWRIGHTCLICK			= "右键点击开启配置选项";

MONKEYBUDDY_CLOCK_HOURSLIDER				= "小时偏移";
MONKEYBUDDY_CLOCK_MINUTESLIDER				= "分钟偏移";

MONKEYBUDDY_CLOCK_ALARMHOURSLIDER			= "定闹钟的时";
MONKEYBUDDY_CLOCK_ALARMMINUTESLIDER			= "设定闹钟的分";

-- bindings
BINDING_NAME_MONKEYBUDDY_OPEN				= "开启控制台";
