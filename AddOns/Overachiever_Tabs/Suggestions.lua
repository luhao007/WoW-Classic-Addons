...
-- Eastern Kingdoms
	...
	["Stranglethorn Vale"] =	-- Need to confirm where these two achievements belong since Cataclysm:
		{ 940, 389, 396, 306},	-- "Master Angler of Azeroth", "The Green Hills of Stranglethorn"
...
-- Outland
	...
	["Shattrath City"] =	-- "My Sack is "Gigantique"", "Old Man Barlowned", "Kickin' It Up a Notch",
		{ 1165, 905, 906, },	-- "Shattrath Divided"
...
-- Northrend
	...
	["Sholazar Basin"] =		-- "The Snows of Northrend", "Honorary Frenzyheart",
		{ 938, 961, 962 },	-- "Savior of the Oracles", "Mercenary of Sholazar"
...
-- Classic Dungeons
	...
	["Stormwind Stockade"] = 633,	-- "Stormwind Stockade"
	["Gnomeregan"] = 634,
	["Razorfen Kraul"] = 635,
	["Razorfen Downs"] = 636,
...
-- Classic Raids
	...
	["The Molten Core"] = 686,
	["Blackwing Lair"] = 685, -- Blackwing Lair (defeat Nefarion)
...
-- Burning Crusade
	...
	["Black Temple"] = 697, -- The Black Temple (defeat Illidan Stormrage)
...
do
  ...
  addtolist(places, ACHID_INSTANCES, ACHID_INSTANCES_NORMAL, ACHID_INSTANCES_HEROIC,
