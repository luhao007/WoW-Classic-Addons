...
V =
    ...
    or C == "esMX" and { -- 25/30 (83%)
      "Habilidades", "Usar otros artículos con el mismo nombre", "Mascota de duelo", "Mascotas de duelo", "Macro personalizado", "Conjunto de equipamientos", "Conjuntos de equipamientos", "Botón de acción extra", "Montura voladora", "Monutra de tierra",
      "Artículo", "Artículos", "Macro", "Macros", "Misceláneo", "Montura", "Monturas", z, "Mostrar sólo al equipar", z,
      "Habilidades de mascota", "Marcador del mundo", "Marcador del mundo", "Marcadores del mundo", "Mostrar esta rodaja siempre", "Hechizo", "Juegete", z, z,
    }
    or C == "frFR" and { -- 29/30 (96%)
      "Compétences", "Également utiliser l'élément avec le même nom", "Mascotte de combat", "Mascottes de combat", "Macro personnalisée", "Set d'équipement", "Équipement de sets", "Bouton d'action supplémentaire", "Montures volantes", "Monture terrestre",
      "Objet", "Objets", "Macro", "Macros", "Divers", "Monture", "Montures", "Nouvelle Macro", "Afficher seulement quand équipé", "Compétence du Familier",
      "Compétences du familier", "Marqueur de Raid", "Marqueur de Terrain", "Marqueurs de Raid", "Afficher un remplacement quand indisponible", "Sort", "Jouet", "Jouets", "Utiliser le rang connu le plus élevé",
    }
    or C == "koKR" and { -- 29/30 (96%)
