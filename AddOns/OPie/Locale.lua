...
V =
	...
	or L == "ruRU" and { -- 118/176 (67%)
		...
		z, "Отключено", "Отображать как вложенное кольцо", "Отображать как:", "Дважды щелкните, чтобы добавить в кольцо.", "Дважды щелкните или перетащите действия ниже в списке фрагмент, чтобы добавить их в кольцо.", "Встраивать в другие кольца по умолчанию", "Вставить часть в это кольцо", "Пустое кольцо", "Увеличивать выбранный фрагмент",
