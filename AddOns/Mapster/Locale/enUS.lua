...
L["After toggling Map Scaling in Mapster you should reload your UI for the changes to fully take effect. Do you want to reload now?"] = true
L["Alpha"] = true
...
L["EJ Icon Scale"] = true
L["Enable Coordinates"] = true
L["Enable FogClear"] = true
L["Enable Map Scaling (Can break the UI in WoW 10.0)"] = true
L["Enable the ability to change the scale of the map. Due to issues in WoW 10.0 this can break your UI in unexpected ways."] = true
L["Faded Alpha"] = true
L["FogClear"] = true
L["Font Size"] = true
...
L["The transparency of the map while you are moving and the map is faded."] = true
