...
BtWQuestsDatabase:AddChain(BTWQUESTS_CHAIN_CLASSIC_DUSKWOOD_CITIZENS_OF_DARKSHIRE, {
    name = L["CITIZENS_OF_DARKSHIRE"],
...
BtWQuestsDatabase:AddCategory(BTWQUESTS_CATEGORY_CLASSIC_DUSKWOOD, {
    ...
    items = {
        {
            type = "chain",
            id = BTWQUESTS_CHAIN_CLASSIC_DUSKWOOD_CITIZENS_OF_DARKSHIRE,
        },
        {
            type = "chain",
