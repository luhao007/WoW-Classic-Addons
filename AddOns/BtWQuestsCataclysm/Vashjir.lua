...
Database:AddChain(Chain.DefenseOfTheBrinyCutter, {
    name = L["DEFENSE_OF_THE_BRINY_CUTTER"],
...
Database:AddChain(Chain.DefenseOfTheImmortalCoil, {
    name = L["DEFENSE_OF_THE_IMMORTAL_COIL"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {80,85},
    major = true,
...
Database:AddChain(Chain.ABuddingTreasureHunter, {
    name = L["A_BUDDING_TREASURE_HUNTER"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {80,85},
    major = true,
