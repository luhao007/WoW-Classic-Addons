...
Database:AddChain(Chain.WildWildWildhammerWedding, {
    name = L["WILD_WILD_WILDHAMMER_WEDDING"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {84,85},
    major = true,
...
Database:AddChain(Chain.ReturningToTheHighlands, {
    name = L["RETURNING_TO_THE_HIGHLANDS"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {84,85},
    major = true,
...
Database:AddChain(Chain.Chain02, {
    ...
    prerequisites = {
        ...
        {
            type = "chain",
            id = BtWQuests.Constant.Chain.Cataclysm.TwilightHighlands.TheAttackBeginsAlliance,
            upto = 27485,
        },
        {
            type = "chain",
            id = BtWQuests.Constant.Chain.Cataclysm.TwilightHighlands.TheAttackBeginsHorde,
            upto = 27486,
        },
    },
    items = {
