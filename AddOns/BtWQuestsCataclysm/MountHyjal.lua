...
Database:AddChain(Chain.TheReturnOfTheAncients, {
    name = L["THE_RETURN_OF_THE_ANCIENTS"],
...
Database:AddChain(Chain.ForayIntoTheFirelands, {
    name = L["FORAY_INTO_THE_FIRELANDS"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {80,85},
    major = true,
...
Database:AddChain(Chain.CavortingWithCultists, {
    name = L["CAVORTING_WITH_CULTISTS"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {80,85},
    major = true,
...
Database:AddChain(Chain.ExtinguishTheFirelord, {
    name = L["EXTINGUISH_THE_FIRELORD"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {80,85},
    major = true,
