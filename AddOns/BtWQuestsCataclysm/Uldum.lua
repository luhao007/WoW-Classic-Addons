...
Database:AddChain(Chain.TheHighCouncilsDecision, {
    name = L["THE_HIGH_COUNCILS_DECISION"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {83,85},
    major = true,
...
Database:AddChain(Chain.TheseObelisksAreTryingToKillUs, {
    name = L["THESE_OBELISKS_ARE_TRYING_TO_KILL_US"],
    category = CATEGORY_ID,
    expansion = EXPANSION_ID,
    range = {83,85},
    major = true,
...
Database:AddChain(Chain.Chain01, {
    ...
    prerequisites = {
        ...
        {
            type = "chain",
            id = BtWQuests.Constant.Chain.Cataclysm.Uldum.TheHighCouncilsDecision,
            upto = 27628,
        },
    },
    items = {
