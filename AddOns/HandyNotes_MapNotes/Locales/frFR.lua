...
L["It is recommended not to enable this option if you want this icon to appear on the minimap, as MapNotes does not display its own icon on the world map or minimap"] = "Il est recommandé de ne pas activer cette option si vous souhaitez que cette icône apparaisse sur la mini-carte, car MapNotes n’affiche pas sa propre icône sur la carte du monde ou la mini-carte"
L["Changes take effect immediately, but are only displayed correctly in the Blizzard Minimap dropdown menu after reloading the UI"] = "Les changements prennent effet immédiatement, mais ne s’affichent correctement dans le menu déroulant de la mini-carte de Blizzard qu’après un rechargement de l’interface"
L["After disabling this option, the player's previous settings are restored"] = "Après la désactivation de cette option, les paramètres précédents du joueur sont restaurés"
-- toggle maps
L["Blocked in combat"] = "Bloqué en combat"
L["Required for"] = "Requis pour"
L["Toggle Maps"] = "Basculer les cartes"
L["Toggle Maps function is disabled"] = "La fonction « Basculer les cartes » est désactivée"
L["Switch after battle"] = "Changer après le combat"
L["Changing the world map via a MapNotes icon will be done after the battle, as this is no longer possible during the battle without causing an error"] = "Le changement de la carte du monde via une icône MapNotes sera effectué après le combat, car cela n’est plus possible pendant le combat sans provoquer une erreur"
L["Shows an information on the screen when a map change has been attempted in battle"] = "Affiche une information à l’écran lorsqu’un changement de carte a été tenté en combat"
L["Enables the ability to toggle the displayed world map by clicking on certain MapNotes icons"] = "Permet de basculer la carte du monde affichée en cliquant sur certaines icônes de MapNotes"
L["This was previously enabled automatically and is now an option to enable or disable"] = "Ceci était auparavant activé automatiquement et est maintenant une option à activer ou désactiver"
-- Flightmaster maps
L["Button"] = "Bouton"
L["Show the MapNotes button on the Flightmap"] = "Afficher le bouton MapNotes sur la carte des trajets aériens"
L["Show Instances"] = "Afficher les instances"
...
L["Mouse coordinates"] = "Coordonnées de la souris"
L["Player coordinates"] = "Coordonnées du joueur"
L["Hold down Shift + Left mouse button to move"] = "Maintenez Maj + bouton gauche de la souris pour déplacer"
...
L["Two mouse coordinate windows are created on the world map: one on the minimized world map and one on the maximized world map"] = "Deux fenêtres d’affichage des coordonnées de la souris sont créées sur la carte du monde : l’une sur la carte du monde réduite et l’autre sur la carte du monde agrandie"
L["The mouse coordinate windows share size and transparency, but can be positioned differently"] = "Ces fenêtres partagent la même taille et la même transparence, mais peuvent être positionnées différemment"
...
L["No boss data available for this instance"] = "Aucune donnée de boss disponible pour cette instance"
...
L["Enable „Link“ in MapNotes („General“ - „Chat-Options“)"] = "Activer « Lien » dans MapNotes (« Général » - « Options de discussion »)"
L["to create clickable quest or achievement links in chat"] = "pour créer des liens cliquables de quêtes ou de hauts faits dans le chat"
...
L["Way to the Delve Entrance"] = "Chemin vers l’entrée du Gouffre"
...
L["Adventure guide function is disabled"] = "La fonction « Guide de l’aventurier » est désactivée"
L["Clicking on an instance icon outside of a zone map does not open the adventure guide, but rather the world map where the instance is located"] = "Cliquer sur une icône d’instance en dehors d’une carte de zone n’ouvre pas le Guide de l’aventurier, mais la carte du monde de la zone où se trouve l’instance"
L["The „Toggle Maps“ function is responsible for this"] = "La fonction « Basculer les cartes » en est responsable"
