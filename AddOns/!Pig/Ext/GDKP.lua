...
--------
local Tooltip = "拾取记录，快速拍卖/出价，补助/罚款记录，分G助手等功能"
local fuFrame,fuFrameBut = PIGOptionsList(L["PIGaddonList"][L.extLsit[2]],"EXT")
fuFrame.errtishi = PIGFontString(fuFrame,{"TOP", fuFrame, "TOP", 0,-140},"没有安装<"..L["PIGaddonList"][L.extLsit[2]]..">模块","OUTLINE",20);
fuFrame.errtishi:SetTextColor(1, 0, 0, 1);
fuFrame.errtishi1 = PIGFontString(fuFrame,{"TOP", fuFrame, "TOP", 0,-180},L["PIGaddonList"][L.extLsit[2]]..": "..Tooltip);
...
Data.Ext[L.extLsit[2]]={fuFrame,fuFrameBut,Tooltip,function() fuFrame.errtishi:Hide() fuFrame.errtishi1:Hide() addname_ot:Hide() end}