...
local CVarsList1 = {
	...
	{SHOW_BUFF_DURATION_TEXT,"buffDurations","1","0",OPTION_TOOLTIP_SHOW_BUFF_DURATION,true},
	...
	{ACTION_BUTTON_USE_KEY_DOWN,"ActionButtonUseKeyDown","1","0",OPTION_TOOLTIP_ACTION_BUTTON_USE_KEY_DOWN,true},
