...
function BagBankfun.qiyongzidongzhengli()
	...
	local CLASSES = {
		...
		-- arrow箭
		{
			containers = {2101,5439,7278,11362,3573,3605,7371,8217,2662,19319,18714,29143,29144,34105,34100,216514,44448},
		...
		-- bullet子弹
		{
			containers = {2102,5441,7279,11363,3574,3604,7372,8218,2663,19320,29118,34106,34099,216515,44447},
			items = set(2516,2519,3033,3465,4960,5568,8067,8068,8069,10512,10513,11284,11630,13377,15997,19317,23772,23773,28060,28061,30612,31735,32761,32882,32883,34582,41164),
		},
		-- ench附魔
		{
		...
		-- herb草药
		{
			...
			items = arrayToSet({765, 785, 1401, 2263, 2447, 2449, 2450, 2452, 2453, 3355, 3356, 3357, 3358, 3369, 3818, 3819, 3820, 3821, 4625, 5013, 5056, 
			...
			8153, 10286, 19726, 21886, 22575, 35625, 37704, 52983, 52988, 53986, 52329, 63122, 52987, 52984, 52985}),
		},
		-- mining矿石
		{
			...
			54232, 53039, 52325, 52326,51950, 52186, 52185, 52183, 53038, 54849, 52327}),
		},
		-- leather皮革
		{
