...
local function TalentFrame_ADD()
	...
	if NDui then
		...
		PlayerTalentFrame:SetSize(allwww,gundongHH-20);
	end
	...
	local function ADD_BGtex(self,texname)
		...
		self.BOTTOMLEFT:SetPoint("BOTTOMLEFT", self, "BOTTOMLEFT",8.6, 0);
		...
		self.LEFT:SetPoint("TOPLEFT", self.TOPLEFT, "BOTTOMLEFT",8.6, 0);
