...
L.InfoRaidWarning			= [[You can specify the position and colors of the raid announce frame.
...
L.Warn_Duration				= "Announce duration: %0.1f sec"
L.None						= "None"
L.Random					= "Random"
L.Outline					= "Outline"
...
L.RaidWarnSound				= "Play sound on raid announce"
...
L.ShowReminders				= "Show reminder messages for recommendations, missing mods, or hotfix messages"
...
L.StripServerName			= "Strip realm name in announcements and timers"
...
L.FilterTrashWarnings		= "Filter all trash mob announcements in dungeons"--normal &amp; heroic
...
L.Area_WhisperMessages		= "Auto-Reply/Sharing Message Options"
