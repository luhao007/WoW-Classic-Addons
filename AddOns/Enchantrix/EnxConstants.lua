...
const.baseDisenchantTable = {
 ...
 [EPIC] = {
 	-- weapon lookups will fall back to the armor table
  [const.ARMOR] = {
   ["bounds"] = { 55, 66, 69, 94, 104, 114, 116, 136, 152, 339, 500 },
   [55]  = { { GETERNAL,  1, 2.0 } },
   [66]  = { { LBRILLIANT,  0.60, 4.0 }, { GETERNAL, 0.25, 3.5 }, { RILLUSION, 0.15, 4.5 }, },
   [69]  = { { VOID,        1.00, 1.0 } },
   [94]  = { { VOID,        1.00, 1.5 } },
   [104] = { { ABYSS,       1.00, 1.0 } },
   [114] = { { MAELSTROM,   1.00, 1.0 } },
   [116] = { { SHA_FRAGMENT, 1.00, 1.0 } },
...
--	[FRACTEMPORAL]  = { 601, 800 }, -- Fractured Temporal Crystal			-- underskilled result
	[SHA_CRYSTAL]   = { 117, 136 }, -- Sha Crystal
	[SHA_FRAGMENT]  = { 115, 116 }, -- Sha Crystal Fragment
	...
	[SETHERAL]        = { 109, 114 }, -- Small Etheral Shard
	[HEAVENLY_SHARD]  = { 107, 108 }, -- Heavenly Shard
	[SHEAVENLY_SHARD] = { 101, 106 }, -- Small Heavenly Shard
	[DREAM_SHARD]     = {  96, 100 }, -- Dream Shard
	[SDREAM_SHARD]    = {  81,  95 }, -- Small Dream Shard
	[LPRISMATIC]      = {  70,  80 }, -- Large Prismatic Shard
	...
	[GCOSMIC]     = {  89, 100 }, -- Greater Cosmic Essence
	[LCOSMIC]     = {  81,  88 }, -- Lesser Cosmic Essence
	[GPLANAR]     = {  70,  80 }, -- Greater Planar Essence
	[LPLANAR]     = {  59,  69 }, -- Lesser Planar Essence
	[GETERNAL]    = {  46,  58 }, -- Greater Eternal Essence
	...
	[HYPNOTIC]  = { 101, 106 }, -- Hypnotic Dust
	[INFINITE]  = {  81, 100 }, -- Infinite Dust
	[ARCANE]    = {  59,  80 }, -- Arcane Dust
	[RILLUSION] = {  46,  58 }, -- Rich Illusion Dust
	[ILLUSION]  = {  26,  45 }, -- Light Illusion Dust
