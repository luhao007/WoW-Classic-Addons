...
L["AUTOASSIGN_DESC"] = [=[Asignar automáticamente todas las bendiciones basadas enla cantidad de paladines disponiblesy sus bendiciones disponibles.|cffffffff [Shift-clic izquierdo]|r Usar campo de batallaplantilla de asignación en lugar de Raidplantilla de asignación.]=]
...
L["BRPT_DESC"] = [=[Informar todas las bendicionesasignaciones a laRaid o Party channel.]=]
...
L["DRAGHANDLE"] = [=[|cffffffff [clic izquierdo]|r |cffff0000Lock|r / |cff00ff00Unlock|r PallyPower|cffffffff [Hacer clic con el botón izquierdo]|r Mover PallyPower|cffffffff [clic derecho]|r Abrir asignaciones de bendición|cffffffff [Shift-Click-derecho]|r Abrir Opciones]=]
...
L["FREEASSIGN_DESC"] = [=[Permitir que otros cambien subendiciones sin ser fiestaAsistente de Líder / Raid.]=]
...
L["LAYOUT_DESC"] = [=[Vertical [Izquierda / Derecha]Horizontal [Arriba / Abajo]]=]
...
L["OPTIONS"] = "Opciones"
L["OPTIONS_DESC"] = [=[Abre el PallyPowerpanel de opciones de complementos.]=]
...
L["PP_CLEAR"] = "Borrar"
L["PP_CLEAR_DESC"] = [=[Borra todas las bendicionesasignaciones para sí mismo,Party y Raid Paladins.]=]
...
L["PP_REFRESH_DESC"] = [=[Actualiza todas las bendicionestareas, talentos ySímbolo de reyes entre sí,Party y Raid Paladins.]=]
...
L["REPORTCHANNEL_DESC"] = [=[Establezca la ventana deseada para transmitir el Informe Bliessings a:|cffffd200 [Ninguno]|r Selecciona el canal en función de la composición del grupo. (Fiesta / Raid)|cffffd200 [Lista de canales]|r Una lista de canales autocompletada basada en los canales a los que se ha unido el reproductor. Los canales predeterminados como Trade, General, etc. se filtran automáticamente de la lista.|cffffff00Nota: Si cambia su orden de canal, deberá volver a cargar su IU y verificar que se está transmitiendo al canal correcto.|r]=]
...
L["SALVCOMBAT_DESC"] = [=[Si habilita esta opción, podrá pulir Guerreros, Druidas y Paladines con Mayor Bendición de Salvación durante el combate.|cffffff00Nota: Esta configuración SOLO se aplica a los grupos de incursiones porque en nuestra cultura actual, muchos tanques usan scripts / complementos para cancelar las mejoras que solo se pueden hacer mientras no están en combate. Esta opción es básicamente una seguridad para evitar pulir accidentalmente un tanque con salvación durante el combate.|r]=]
