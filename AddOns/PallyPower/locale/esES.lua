...
L["AUTO_DESC"] = [=[[|cffffd200Enable|r / |cffffd200Disable|r] El botón Auto Buff o
[|cffffd200Enable|r / |cffffd200Disable|r] Espera a los jugadores.]=]
L["AUTOASSIGN"] = "Auto-Assign"
L["AUTOASSIGN_DESC"] = [=[Asignar automáticamente todas
las bendiciones basadas en la
cantidad de paladines disponibles
y sus bendiciones disponibles.

|cffffffff [Shift-clic izquierdo]|r Usar campo de
batalla plantilla de asignación en
lugar de Raid plantilla de asignación.]=]
...
L["BRPT"] = "Reporte"
L["BRPT_DESC"] = [=[Informar todas las
bendiciones asignaciones
a la Raid o Party channel.]=]
...
L["DRAG_DESC"] = "[|cffffd200Enable|r / |cffffd200Disable|r] El botón de arrastre de la manija."
...
L["FREEASSIGN_DESC"] = [=[Permitir que otros cambien
su bendiciones sin ser fiesta
Asistente de Líder / Raid.]=]
...
L["MINIMAPICON"] = [=[|cffffffff [Clic izquierdo]|r Abrir asignaciones de bendición|cffffffff [clic derecho]|r Abrir opciones]=]
L["NONE"] = "Ninguno"
...
L["PP_REFRESH_DESC"] = [=[Actualiza todas las bendiciones tareas,
talentos y Símbolo de reyes entre sí,
Party y Raid Paladins.]=]
...
L["RAID"] = "Raid"
L["RAID_DESC"] = "Opciones de solo incursión"
...
|cffffd200 [Ninguno]|r Selecciona el canal en función de la composición del grupo. (Fiesta / Raid)

|cffffd200 [Lista de canales]|r Una lista de canales autocompletada basada en los canales a los que se ha unido el reproductor. Los canales predeterminados como Trade, General, etc. se filtran automáticamente de la lista.
...
L["RESIZEGRIP"] = [=[Hacer clic con el botón izquierdo para mantener el tamañoEl botón derecho restablece el tamaño predeterminado]=]
...
|cffffff00Nota: Esta configuración SOLO se aplica a los grupos de incursiones porque en nuestra cultura actual, muchos tanques usan scripts / complementos para cancelar las mejoras que solo se pueden hacer mientras no están en combate. Esta opción es básicamente una seguridad para evitar pulir accidentalmente un tanque con salvación durante el combate.|r]=]
...
L["SHOWPETS_DESC"] = [=[Si habilita esta opción, las mascotas aparecerán en su propia clase.|cffffff00Nota: Debido a la forma en que funcionan las Bendiciones Mayores y la forma en que se clasifican las mascotas, las mascotas deberán ser pulidas por separado. Además, los Imp Warlock se ocultarán automáticamente a menos que el Cambio de fase esté desactivado. |r]=]
...
L["USEPARTY"] = "Uso en fiesta"
L["USEPARTY_DESC"] = "[Activar / Desactivar] PallyPower en la fiesta"
...
L["WAIT_DESC"] = "Si esta opción está habilitada, el botón Auto Buff y los botones Class Buff no mejorarán automáticamente una Bendición Mayor si los destinatarios no están dentro del rango de Paladins (100yds). Esta verificación de rango excluye AFK, Dead y jugadores sin conexión ."
