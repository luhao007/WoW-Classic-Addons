...
L.ITEM_EXPLAIN_LABEL = "|cffFFFFFFThis content is always shown if you are in |c" .. _.DefaultColors.Account .. "Account Mode|r.|r";
...
L.STORE_IN_PROFILE_BUTTON = "Store in Profile";
L.STORE_IN_PROFILE_BUTTON_TOOLTIP = "By default, ATT stores these Filters on a per-character basis.\n\nCheck this option to store these Filter selections in the current Profile rather than per-character.";
...
localize(L.HEADER_NAMES, {
	...
	[-247] = select(2,GetAchievementInfo(2091))..": Season 1",
	[-248] = select(2,GetAchievementInfo(418))..": Season 2",
	[-249] = select(2,GetAchievementInfo(419))..": Season 3",
	[-250] = select(2,GetAchievementInfo(420))..": Season 4",
	[-251] = select(2,GetAchievementInfo(3336))..": Season 5",
	[-252] = "Hateful Gladiator",
	[-253] = select(2,GetAchievementInfo(3436))..": Season 6",
	[-254] = select(2,GetAchievementInfo(3758))..": Season 7",
	[-255] = select(2,GetAchievementInfo(4599))..": Season 8",
	[-291] = ARENA,
	[-292] = BATTLEGROUNDS,
	[-295] = "Elite Gear",
	[-296] = "Gladiator Gear",
...
localize(L.HEADER_ICONS, {
	...
	[-237] = _.asset("expansion_cata"),
	[-238] = _.asset("expansion_mop"),
	[-239] = _.asset("expansion_wod"),
	[-243] = 237019,
	[-245] = 237018,
	[-247] = 236534,
	[-248] = 236535,
	...
	[-566] = _.asset("holiday_day_of_the_dead"),
...
_.FlightPathNames = {
	...
	[375] = "REUSEME",
	[376] = "AAAIcecrown Raid - Airship Battle Taxi Paths",
	[377] = "Icecrown Dungeon - Gunships",
	[379] = "AAAAIcecrown Raid - Saurfang's Ship (End)",
	[380] = "AAAAIcecrown Raid - Saurfang's Ship (Start)",
	[381] = "AAAAQuest [Transport] Icecrown Raid - Saurfang Ship (START)",
...
local HORDE_BONFIRES = { 187559,187947,187948,187949,187950,187951,187952,187953,187954,187955,187956,187957,187958,187959,187960,187961,187962,187963,187964,187965,187966,187967,187968,187969,187970,187971,187972,187973,187974,187975,194033,194034,194037,194039,194042,194043,194046,194048 };
...
localize(L.HEADER_NAMES, {
	...
	[-59] = "Waffenmeisterin",
	[-71] = "Verteidigungsprotokoll Alpha",
	...
	[-576] = "Schlotternächte",
	[-577] = "Erntedankfest",
	[-578] = "Angelwettstreit der Kalu'ak",
	[-579] = "Liebe liegt in der Luft",
	[-580] = "Mondfest",
	[-582] = "Sonnenwendfest",
	[-583] = "Nobelgartenfest",
	[-584] = "Pilgerfreudenfest",
	[-585] = "Piratentag",
...
L.ITEM_EXPLAIN_LABEL = "|cffFFFFFFCe contenu est toujours affiché si vous êtes en |c" .. _.DefaultColors.Account .. "Mode Compte|r.|r";
...
localize(L.HEADER_NAMES, {
	...
	[-59] = "Maître d'armes",
	[-71] = "Protocole de défense Alpha",
	[-72] = "Protocole de défense Bêta",
	[-73] = "Protocole de défense Gamma",
	[-74] = "Dragons du Cauchemar",
	[-83] = "Événement chronométré",
	[-84] = "Premier coffre",
	[-85] = "Second coffre",
	[-86] = "Troisième coffre",
	[-87] = "Coffre final",
	...
	[-250] = select(2,GetAchievementInfo(420))..": Saison 4",
	[-251] = select(2,GetAchievementInfo(3336))..": Saison 5",
	[-252] = "Gladiateur Haineux",
	[-253] = select(2,GetAchievementInfo(3436))..": Saison 6",
	[-254] = select(2,GetAchievementInfo(3758))..": Saison 7",
	[-255] = select(2,GetAchievementInfo(4599))..": Saison 8",
...
localize(ObjectNames, {
	...
	[191092] = "Restes du grand inquisiteur Valroth",
...
localize(L.HEADER_NAMES, {
	...
	[-368] = "Assalto alla rocca",
	[-369] = "Sale della Pestilenza",
	[-371] = "Sale delle Ali del Gelo",
...
localize(ObjectNames, {
	...
	[191092] = "Resti del Gran Inquisitore Valroth",
...
localize(L.HEADER_NAMES, {
	...
	[-578] = "Campeonato de Pesca dos Kalu'ak",
	[-579] = "O Amor Está No Ar",
	[-580] = "Festival da Lua",
	[-582] = "Festival do Fogo do Solstício",
	[-583] = "Jardinova",
	[-584] = "Festa da Fartura",
	[-585] = "Dia dos Piratas",
...
localize(L.HEADER_NAMES, {
	...
	[-61] = "Мировые Боссы",
	[-63] = "Добыча локации",
	[-71] = "Защитный протокол \"Альфа\"",
	[-72] = "Защитный протокол \"Бета\"",
	[-73] = "Защитный протокол \"Гамма\"",
	[-74] = "Драконы Кошмара",
	[-83] = "Временное Событие",
	[-84] = "Первый Сундук",
	[-85] = "Второй Сундук",
	[-86] = "Третий Сундук",
	[-87] = "Последний Сундук",
	...
	[-248] = select(2,GetAchievementInfo(418))..": Сезон 2",
	[-249] = select(2,GetAchievementInfo(419))..": Сезон 3",
	[-250] = select(2,GetAchievementInfo(420))..": Сезон 4",
	[-251] = select(2,GetAchievementInfo(3336))..": Сезон 5",
	[-252] = "Злобный гладиатор",
	[-253] = select(2,GetAchievementInfo(3436))..": Сезон 6",
	[-254] = select(2,GetAchievementInfo(3758))..": Сезон 7",
	[-255] = select(2,GetAchievementInfo(4599))..": Сезон 8",
	[-295] = "Элитные доспехи",
...
L.ENSEMBLE_LEARNED = "Este conjunto ya ha sido usado por uno de tus personajes.\n\n|cFFA0A0A0Desafortunadamente, el sistema de Blizzard a veces puede fallar al otorgar todos los objetos.|r";
...
L.ITEM_EXPLAIN_LABEL = "|cffFFFFFFEste contenido se muestra siempre si estás en |c" .. _.DefaultColors.Account .. "Modo Cuenta|r.|r";
...
L.STORE_IN_PROFILE_BUTTON = "Guardado en el perfil";
L.STORE_IN_PROFILE_BUTTON_TOOLTIP = "De forma predeterminada, ATT almacena estos filtros por personaje.\n\nMarque esta opción para almacenar estas selecciones de filtros en el perfil actual en lugar de por personaje.";
...
localize(_.CategoryNames, {
	...
	[853] = "Collares",
	[854] = "Anillos",
	[855] = "Gemas prismáticas",
	[856] = "Mascotas y proyectos",
	[857] = "Gemas azules",
	[858] = "Gemas verdes",
	[859] = "Gemas naranjas",
	[860] = "Gemas moradas",
...
localize(L.HEADER_NAMES, {
	...
	[-61] = "Jefes de mundo",
	[-63] = "Botín de zona",
	[-71] = "Protocolo de defensa Alfa",
	[-72] = "Protocolo de defensa Beta",
	[-73] = "Protocolo de defensa Gamma",
	[-74] = "Dragones de la pesadilla",
	[-83] = "Evento cronometrado",
	[-84] = "Primer cofre",
	[-85] = "Segundo cofre",
	[-86] = "Tercer cofre",
	[-87] = "Cofre final",
	...
	[-247] = select(2,GetAchievementInfo(2091))..": Temporada 1",
	[-248] = select(2,GetAchievementInfo(418))..": Temporada 2",
	[-249] = select(2,GetAchievementInfo(419))..": Temporada 3",
	[-250] = select(2,GetAchievementInfo(420))..": Temporada 4",
	[-251] = select(2,GetAchievementInfo(3336))..": Temporada 5",
	[-252] = "Gladiador Odioso",
	[-253] = select(2,GetAchievementInfo(3436))..": Temporada 6",
	[-254] = select(2,GetAchievementInfo(3758))..": Temporada 7",
	[-255] = select(2,GetAchievementInfo(4599))..": Temporada 8",
	[-295] = "Equipo de Elite",
	...
	[-566] = "Festividad de los Muertos",
	[-574] = "El festín del Festival de Invierno",
	[-576] = "Halloween",
	[-577] = "Festival de la Cosecha",
	[-578] = "Competición de pesca Kalu'ak",
	[-579] = "Amor en el aire",
	[-580] = "Festival Lunar",
	[-582] = "Festival de Fuego del Solsticio de Verano",
	[-583] = "Jardín Noble",
	[-584] = "Generosidad del Peregrino",
	[-585] = "Día de los Piratas",
...
for key,value in pairs({
	...
	[3001] = "|cFFAAFFAA¡Esto solo estaba disponible para el primer jugador que hiciera la acción en tu reino!|r",
...
for key,value in pairs({
	...
	[3001] = "|cFFFFAAAAPero si fuiste el primero en el reino, bien por ti.|r",
...
L.SHOW_ALL_SEASONAL = "Todos los eventos de estacionales";
...
L.ITEM_EXPLAIN_LABEL = "|cffFFFFFF|c" .. _.DefaultColors.Account .. "帐号模式|r下，这些内容始终显示。|r";
...
L.READDED_WITH_PATCH_CLASSIC_FORMAT = "该物品是随补丁 %s 重新添加的";
L.REAGENT = "材料";
...
L.SPELL_NAME = "法术名称";
L.SPLIT = "按难度";
L.STORE_IN_PROFILE_BUTTON = "储存在配置文件中";
L.STORE_IN_PROFILE_BUTTON_TOOLTIP = "默认情况下，ATT按每个角色存储这些过滤器。\n\n选择此选项可将这些“过滤器”存储在当前配置文件中，而不是按角色存储。";
...
localize(L.HEADER_NAMES, {
	...
	[-250] = select(2,GetAchievementInfo(420)).."：第4赛季",
	[-251] = select(2,GetAchievementInfo(3336)).."：第5赛季",
	[-252] = "憎恨角斗士",
	[-253] = select(2,GetAchievementInfo(3436)).."：第6赛季",
	[-254] = select(2,GetAchievementInfo(3758)).."：第7赛季",
	[-255] = select(2,GetAchievementInfo(4599)).."：第8赛季",
	[-295] = "精锐装备",
	[-296] = "角斗士装备",
...
localize(L.HEADER_NAMES, {
	...
	[-250] = select(2,GetAchievementInfo(420)).."：第4賽季",
	[-251] = select(2,GetAchievementInfo(3336)).."：第5賽季",
	[-252] = "憎恨鬥士",
	[-253] = select(2,GetAchievementInfo(3436)).."：第6賽季",
	[-254] = select(2,GetAchievementInfo(3758)).."：第7賽季",
	[-255] = select(2,GetAchievementInfo(4599)).."：第8賽季",
	[-295] = "精英裝備",
	[-296] = "鬥士裝備",
	[-318] = "T0.5套裝",
	[-341] = "共享外觀",
