...
for key,value in pairs({
	...
	-- General Content
		...
		-- Collectible Things
		--TODO: ACC_WIDE_DEFAULT = "Tracked ".. app.ccColors.Account .. "A livello di account|R by default.";
		--TODO: TRACK_ACC_WIDE = app.ccColors.Account .. "Track A livello di account|R";
		...
		--TODO: DRAKEWATCHERMANUSCRIPTS_CHECKBOX_TOOLTIP = "Enable this option to track Dragonflight Manoscritto del Guardadraghi";
		...
		--TODO: SOULBINDCONDUITS_CHECKBOX_TOOLTIP = "Enable this option to track Shadowlands Condotti.";
