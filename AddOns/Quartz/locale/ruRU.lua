...
L["Center"] = "В центре"
L["Center (Backdrop)"] = "Центр (фон)"
L["Center (CastBar)"] = "Центр (полоса применения)"
...
L["Disable the text that displays the spell name"] = "Не отображать название и уровень заклинания"
...
L["Display the name of the spell on the bars"] = "Отображать название заклинания на полосе"
...
L["Display the time remaining on the bars"] = "Отображать оставшееся время на полосе"
L["Down"] = "Низ"
...
L["Enemy CastBars"] = "Полоса применения противника"
...
L["Only show the casts of enemys when inside an instance (dungeon or raid)"] = "Показывать полосы применения противников только в подземельях или рейдах"
...
L["Position"] = "Позиция"
L["Position the bars"] = "Позиция полос"
...
L["Select where to anchor the bars"] = "Установить место закрепления полос"
...
L["Set the alpha of the bars"] = "Установить прозрачность полос"
...
L["Set the bar Texture"] = "Установить текстуру полосы"
...
L["Set the color of the bars"] = "Установить цвет полосы"
...
L["Set the color of the text for the bars"] = "Установить цвет текста на полосах"
...
L["Set the font size for the bars"] = "Установить размер шрифта на полосах"
...
L["Set the font used in the bars"] = "Установить шрифт, использующийся на полосах"
...
L["Set the grow direction of the bars"] = "Установить направление роста полос"
L["Set the height of the bars"] = "Установить высоту полос"
...
L["Set the side of the bar that the icon appears on"] = "Установить сторону полосы, на которой должна находиться иконка заклинания"
...
L["Set the width of the bars"] = "Установить ширину полосы"
...
L["Show icons on the bars"] = "Показывать иконки на полосах"
...
L["Toggle bar lock"] = "Закрепить полосы"
...
L["Tweak the horizontal position of the bars"] = "Настроить положение полос по горизонтали"
L["Tweak the horizontal position of the bars for your %s"] = "Настроить горизотальную позицию баров для вашего %s"
L["Tweak the space between bars"] = "Настроить промежутки между полосами"
L["Tweak the space between bars for your %s"] = "Настроить расстояние между барами для вашего %s"
L["Tweak the vertical position of the bars"] = "Настроить положение полос по вертикали"
L["Tweak the vertical position of the bars for your %s"] = "Настроить вертикальную позицию баров для вашего %s"
L["Tweak the vertical position of thebars"] = "Настроить положение полос по вертикали"
