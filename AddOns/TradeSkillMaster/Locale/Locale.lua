...
do
	...
	if locale == "enUS" or locale == "enGB" then
		...
		TSM.L["Above max price. Posting at max."] = "Above max price. Posting at max."
		TSM.L["Above max price. Posting at min."] = "Above max price. Posting at min."
		TSM.L["Above max price. Posting at normal."] = "Above max price. Posting at normal."
		...
		TSM.L["Below min price. Posting at max."] = "Below min price. Posting at max."
		TSM.L["Below min price. Posting at min."] = "Below min price. Posting at min."
		TSM.L["Below min price. Posting at normal."] = "Below min price. Posting at normal."
		...
		TSM.L["Canceling auction you've undercut."] = "Canceling auction you've undercut."
		...
		TSM.L["TSM is not yet ready to establish a new sync connection. Please try again later."] = "TSM is not yet ready to establish a new sync connection. Please try again later."
		TSM.L["TSM4"] = "TSM4"
		...
		TSM.L["Text (%s)"] = "Text (%s)"
		TSM.L["The 'Craft Value Method' did not return a value for this item."] = "The 'Craft Value Method' did not return a value for this item."
		...
		TSM.L["The min profit did not evalulate to a valid value for this item."] = "The min profit did not evalulate to a valid value for this item."
		...
		TSM.L["You either already have at least your max restock quantity of this item or the number which would be queued is less than the min restock quantity."] = "You either already have at least your max restock quantity of this item or the number which would be queued is less than the min restock quantity."
