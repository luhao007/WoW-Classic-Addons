...
local NamedTupleList = LibTSMUtil:DefineClassType("NamedTupleList")
...
function NamedTupleList.__static.New(...)
	return NamedTupleList(...)
end
...
function NamedTupleList.__private:__init(...)
	self._data = {}
	self._fields = {}
...
function NamedTupleList:RemoveRow(rowIndex)
	...
	Table.RemoveRange(data, (rowIndex - 1) * numFields + 1, rowIndex * numFields)
end
