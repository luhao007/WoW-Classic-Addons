...
function private.UpdateBaseItemInfoQuery()
	...
	private.baseItemInfoQuery = ItemInfo.MatchItemFilterQuery(private.itemFilter, private.baseItemInfoQuery)
		...
		:IsNil("groupPath")
		:OrderBy("name", true)
		:VirtualField("coloredItemName", "string", UIUtils.GetColoredItemName, "itemString", Theme.GetColor("FEEDBACK_RED"):ColorText("?"))
	if shouldPause then
...
function private.CreateUngroupedBagItemQuery()
	return BagTracking.CreateQueryBags()
		...
		:VirtualField("coloredItemName", "string", UIUtils.GetColoredItemName, "ungroupedItemString", Theme.GetColor("FEEDBACK_RED"):ColorText("?"))
