...
local Toggle = UIElements.Define("Toggle", "Element")
Toggle:_ExtendStateSchema()
	:AddStringField("font", "BODY_BODY3")
	:AddOptionalStringField("selectedOption")
	:AddBooleanField("disabled", false)
	:Commit()
Toggle:_AddActionScripts("OnValueChanged")
...
function Toggle.__private:_CreateCheckbox(option)
...
function Toggle.__private:_HandleCheckboxClick(checkbox)
