...
--************************************************
	...
	SMGraveyard = {
		ZoneName = { BZ["Scarlet Monastery"]..ALC["Colon"]..L["Graveyard"] },
		Location = { BZ["Tirisfal Glades"] },
		LevelRange = "31-34",
		MinLevel = "21",
		PlayerLimit = { 5 },
	...
	Scholomance = {
		...
		{ WHIT.." 5) "..Atlas:GetBossName("Rattlegore")..ALC["L-Parenthesis"]..L["Lower"]..ALC["R-Parenthesis"] },
...
--************************************************
	...
	BlackfathomDeeps = {
		...
		{ WHIT.." 6) "..Atlas:GetBossName("Lorgus Jett")..ALC["L-Parenthesis"]..L["Varies"]..ALC["R-Parenthesis"] },
	...
	RazorfenDowns = {
		...
		{ WHIT.." 5) "..Atlas:GetBossName("Ragglesnout")..ALC["L-Parenthesis"]..ALC["Rare"]..ALC["Comma"]..L["Varies"]..ALC["R-Parenthesis"] },
