...
-- 边框颜色
-- 主框架初始化
local ChatBar = CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate")
...
local function CreateChannelButton(data, index)
    local frame = CreateFrame("Button", nil, ChatBar, BackdropTemplateMixin and "BackdropTemplate")
