...
function SimpleChat:InitEmoteTableFrame()
    ...
    EmoteTableFrame = CreateFrame("Frame", "EmoteTableFrame", UIParent, BackdropTemplateMixin and "BackdropTemplate")
    ...
    for i = 1, #emotes do
        text = emotes[i][1]
        texture = emotes[i][2]
        icon = CreateFrame("Frame", format("IconButton%d", i), EmoteTableFrame, BackdropTemplateMixin and "BackdropTemplate")
