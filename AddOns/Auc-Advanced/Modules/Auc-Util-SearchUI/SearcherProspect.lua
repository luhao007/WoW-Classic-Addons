--[[
	...
	Revision: $Id: SearcherProspect.lua 6464 2019-10-20 00:10:07Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherProspect.lua $", "$Rev: 6464 $")
