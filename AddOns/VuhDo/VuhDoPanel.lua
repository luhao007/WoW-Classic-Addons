		...
		= function(aUnitId, anotherUnitId)
			...
			elseif (sIsPlayerFirst and anotherUnitId == "player") then return false;
				...
				elseif tRole1 == VUHDO_ID_RANGED_HEAL and 
					...
					return true;
				elseif tRole2 == VUHDO_ID_RANGED_HEAL and 
					(tRole1 == VUHDO_ID_RANGED_DAMAGE or tRole1 == VUHDO_ID_MELEE_DAMAGE) then
					return false;
				elseif tRole1 == VUHDO_ID_MELEE_DAMAGE and tRole2 == VUHDO_ID_RANGED_DAMAGE then
					return true;
