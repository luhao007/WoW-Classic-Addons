...
--------------------
VUHDO_SPELL_ID = { };
VUHDO_SPELL_ID.ABOLISH_DISEASE = VUHDO_getSpellInfo(552);
VUHDO_SPELL_ID.ABOLISH_POISON = VUHDO_getSpellInfo(2893);
...
VUHDO_SPELL_ID.CURE_DISEASE_PRIEST = VUHDO_getSpellInfo(528);
VUHDO_SPELL_ID.CURE_DISEASE_SHAMAN = VUHDO_getSpellInfo(2870);
VUHDO_SPELL_ID.CURE_POISON_DRUID = VUHDO_getSpellInfo(8946);
VUHDO_SPELL_ID.CURE_POISON_SHAMAN = VUHDO_getSpellInfo(526);
...
VUHDO_SPELL_ID.DISPEL_MAGIC = VUHDO_getSpellInfo(527);
...
VUHDO_SPELL_ID.HEAL = VUHDO_getSpellInfo(2054);
...
VUHDO_SPELL_ID.PURIFY = VUHDO_getSpellInfo(1152);
...
VUHDO_SPELL_ID.REMOVE_CURSE = VUHDO_getSpellInfo(2782);
VUHDO_SPELL_ID.REMOVE_LESSER_CURSE = VUHDO_getSpellInfo(475);
...
-- Priest
VUHDO_SPELL_ID.BUFF_POWER_WORD_FORTITUDE        = VUHDO_getSpellInfo(1243);
VUHDO_SPELL_ID.BUFF_PRAYER_OF_FORTITUDE         = VUHDO_getSpellInfo(21562);
VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION           = VUHDO_getSpellInfo(976);
VUHDO_SPELL_ID.BUFF_PRAYER_OF_SHADOW_PROTECTION = VUHDO_getSpellInfo(27683);
VUHDO_SPELL_ID.BUFF_DIVINE_SPIRIT               = VUHDO_getSpellInfo(14752);
VUHDO_SPELL_ID.BUFF_PRAYER_OF_SPIRIT            = VUHDO_getSpellInfo(27681);
...
VUHDO_SPELL_ID.BUFF_MAGMA_TOTEM            = VUHDO_getSpellInfo(25552);
VUHDO_SPELL_ID.BUFF_FIRE_RESISTANCE_TOTEM  = VUHDO_getSpellInfo(25563);
VUHDO_SPELL_ID.BUFF_FROST_RESISTANCE_TOTEM = VUHDO_getSpellInfo(25560);
VUHDO_SPELL_ID.BUFF_FIRE_NOVA_TOTEM        = VUHDO_getSpellInfo(25547);
VUHDO_SPELL_ID.BUFF_SEARING_TOTEM          = VUHDO_getSpellInfo(25533);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_TOTEM      = VUHDO_getSpellInfo(25557);
-- Air
VUHDO_SPELL_ID.BUFF_GROUNDING_TOTEM         = VUHDO_getSpellInfo(8177);
VUHDO_SPELL_ID.BUFF_WINDFURY                = VUHDO_getSpellInfo(25587);
VUHDO_SPELL_ID.BUFF_GRACE_OF_AIR            = VUHDO_getSpellInfo(25359);
VUHDO_SPELL_ID.BUFF_WRATH_OF_AIR            = VUHDO_getSpellInfo(3738);
VUHDO_SPELL_ID.BUFF_NATURE_RESISTANCE_TOTEM = VUHDO_getSpellInfo(25574);
VUHDO_SPELL_ID.BUFF_SENTRY_TOTEM            = VUHDO_getSpellInfo(6495);
VUHDO_SPELL_ID.BUFF_WINDWALL_TOTEM          = VUHDO_getSpellInfo(25577);
VUHDO_SPELL_ID.BUFF_TRANQUIL_AIR_TOTEM      = VUHDO_getSpellInfo(25908);
-- Earth
...
VUHDO_SPELL_ID.BUFF_STRENGTH_OF_EARTH     = VUHDO_getSpellInfo(25528);
VUHDO_SPELL_ID.BUFF_STONECLAW_TOTEM       = VUHDO_getSpellInfo(25525);
VUHDO_SPELL_ID.BUFF_STONESKIN_TOTEM       = VUHDO_getSpellInfo(25509);
-- Water
...
VUHDO_SPELL_ID.BUFF_MANA_SPRING_TOTEM       = VUHDO_getSpellInfo(25570);
VUHDO_SPELL_ID.BUFF_POISON_CLEANSING_TOTEM  = VUHDO_getSpellInfo(8166);
VUHDO_SPELL_ID.BUFF_DISEASE_CLEANSING_TOTEM = VUHDO_getSpellInfo(8170);

-- Weapon Enchants
VUHDO_SPELL_ID.BUFF_ROCKBITER_WEAPON   = VUHDO_getSpellInfo(25485);
VUHDO_SPELL_ID.BUFF_WINDFURY_WEAPON    = VUHDO_getSpellInfo(25505);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_WEAPON = VUHDO_getSpellInfo(25489);
VUHDO_SPELL_ID.BUFF_FROSTBRAND_WEAPON  = VUHDO_getSpellInfo(25500);
VUHDO_SPELL_ID.BUFF_EARTHLIVING_WEAPON = VUHDO_getSpellInfo(51994);
...
VUHDO_SPELL_ID.BUFF_LIGHTNING_SHIELD = VUHDO_getSpellInfo(25020);
VUHDO_SPELL_ID.BUFF_WATER_SHIELD = VUHDO_getSpellInfo(33736);
...
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_KINGS = VUHDO_getSpellInfo(25898);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_WISDOM = VUHDO_getSpellInfo(25894);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_MIGHT = VUHDO_getSpellInfo(25782);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_SANCTUARY = VUHDO_getSpellInfo(25899);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_LIGHT = VUHDO_getSpellInfo(25890);
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_SALVATION = VUHDO_getSpellInfo(25895);
VUHDO_SPELL_ID.BUFF_RIGHTEOUS_FURY = VUHDO_getSpellInfo(25780);
VUHDO_SPELL_ID.BUFF_SACRED_SHIELD = VUHDO_getSpellInfo(53601);


-- Druid
VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD = VUHDO_getSpellInfo(1126);
VUHDO_SPELL_ID.BUFF_GIFT_OF_THE_WILD = VUHDO_getSpellInfo(21849);
VUHDO_SPELL_ID.BUFF_THORNS           = VUHDO_getSpellInfo(467);


-- Warlock
VUHDO_SPELL_ID.BUFF_DEMON_SKIN  = VUHDO_getSpellInfo(687);
VUHDO_SPELL_ID.BUFF_DEMON_ARMOR = VUHDO_getSpellInfo(706);


-- Mage
VUHDO_SPELL_ID.BUFF_ARCANE_INTELLECT   = VUHDO_getSpellInfo(1459);
VUHDO_SPELL_ID.BUFF_ARCANE_BRILLIANCE  = VUHDO_getSpellInfo(23028);
VUHDO_SPELL_ID.BUFF_ICE_BLOCK          = VUHDO_getSpellInfo(11958);
...
VUHDO_SPELL_ID.BUFF_FROST_ARMOR        = VUHDO_getSpellInfo(168);
VUHDO_SPELL_ID.BUFF_ICE_ARMOR          = VUHDO_getSpellInfo(7302);
VUHDO_SPELL_ID.BUFF_DALARAN_INTELLECT  = VUHDO_getSpellInfo(61024);
VUHDO_SPELL_ID.BUFF_DALARAN_BRILLIANCE = VUHDO_getSpellInfo(61316);
VUHDO_SPELL_ID.BUFF_FOCUS_MAGIC        = VUHDO_getSpellInfo(54648);
...
VUHDO_SPELL_ID.BUFF_COMMANDING_SHOUT = VUHDO_getSpellInfo(47440);
...
VUHDO_SPELL_ID.GLOBAL_COOLDOWN = 29515;
