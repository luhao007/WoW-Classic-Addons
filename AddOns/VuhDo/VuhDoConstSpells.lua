...
--------------------
VUHDO_SPELL_ID = { };
VUHDO_SPELL_ID.ABOLISH_DISEASE = VUHDO_getSpellInfoSafe(552);
VUHDO_SPELL_ID.ABOLISH_POISON = VUHDO_getSpellInfoSafe(2893);
VUHDO_SPELL_ID.ABSOLUTION = VUHDO_getSpellInfoSafe(450761);
...
VUHDO_SPELL_ID.ANCESTRAL_VISION = VUHDO_getSpellInfoSafe(450762);
...
VUHDO_SPELL_ID.BLOOD_PACT = VUHDO_getSpellInfoSafe(6307);
VUHDO_SPELL_ID.BLESSING_OF_PROTECTION = VUHDO_getSpellInfoSafe(1022);
...
VUHDO_SPELL_ID.CHAKRA = VUHDO_getSpellInfoSafe(14751);
VUHDO_SPELL_ID.CHAKRA_CHASITISE = VUHDO_getSpellInfoSafe(81209);
VUHDO_SPELL_ID.CHAKRA_SANCTUARY = VUHDO_getSpellInfoSafe(81206);
VUHDO_SPELL_ID.CHAKRA_SERENITY = VUHDO_getSpellInfoSafe(81208);
VUHDO_SPELL_ID.CHRONO_FLAME = VUHDO_getSpellInfoSafe(431442);
VUHDO_SPELL_ID.CIRCLE_OF_HEALING = VUHDO_getSpellInfoSafe(34861);
VUHDO_SPELL_ID.CLARITY_OF_WILL = VUHDO_getSpellInfoSafe(152118);
...
VUHDO_SPELL_ID.CURE_DISEASE_PRIEST = VUHDO_getSpellInfoSafe(528);
VUHDO_SPELL_ID.CURE_DISEASE_SHAMAN = VUHDO_getSpellInfoSafe(2870);
VUHDO_SPELL_ID.CURE_POISON_DRUID = VUHDO_getSpellInfoSafe(8946);
VUHDO_SPELL_ID.CURE_POISON_SHAMAN = VUHDO_getSpellInfoSafe(526);
VUHDO_SPELL_ID.CYCLONE = VUHDO_getSpellInfoSafe(33786);
VUHDO_SPELL_ID.DAWNLIGHT = VUHDO_getSpellInfoSafe(431377);
...
VUHDO_SPELL_ID.DISPEL_MAGIC = VUHDO_getSpellInfoSafe(527);
VUHDO_SPELL_ID.DIVINE_AEGIS = VUHDO_getSpellInfoSafe(47515);
...
VUHDO_SPELL_ID.EFFLORESCENCE = VUHDO_getSpellInfoSafe(145205);
VUHDO_SPELL_ID.EMERALD_BLOSSOM = VUHDO_getSpellInfoSafe(355913);
VUHDO_SPELL_ID.ENKINDLE = VUHDO_getSpellInfoSafe(445740);
...
VUHDO_SPELL_ID.GRACE = VUHDO_getSpellInfoSafe(47517);
VUHDO_SPELL_ID.GREATER_HEAL = VUHDO_getSpellInfoSafe(2060);
VUHDO_SPELL_ID.GROVE_TENDING = VUHDO_getSpellInfoSafe(383193);
VUHDO_SPELL_ID.GUARDIAN_SPIRIT = VUHDO_getSpellInfoSafe(47788);
VUHDO_SPELL_ID.HAND_OF_RECKONING = VUHDO_getSpellInfoSafe(62124);
VUHDO_SPELL_ID.HEAL = VUHDO_getSpellInfoSafe(2054);
VUHDO_SPELL_ID.HEALING_TOUCH = VUHDO_getSpellInfoSafe(5185);
VUHDO_SPELL_ID.HEALING_WAVE = VUHDO_getSpellInfoSafe(331);
...
VUHDO_SPELL_ID.HOLY_WORD_SERENITY = VUHDO_getSpellInfoSafe(88684);
VUHDO_SPELL_ID.HYDROBUBBLE = VUHDO_getSpellInfoSafe(444490);
VUHDO_SPELL_ID.ICE_BARRIER = VUHDO_getSpellInfoSafe(11426);
VUHDO_SPELL_ID.ILLUMINATED_HEALING = VUHDO_getSpellInfoSafe(86273);
VUHDO_SPELL_ID.INCANTERS_WARD = VUHDO_getSpellInfoSafe(1463);
...
VUHDO_SPELL_ID.LUMINOUS_BARRIER = VUHDO_getSpellInfoSafe(271466);
VUHDO_SPELL_ID.MANA_SHIELD = VUHDO_getSpellInfoSafe(1463);
VUHDO_SPELL_ID.MASS_RESURRECTION = VUHDO_getSpellInfoSafe(83968);
...
VUHDO_SPELL_ID.MINOR_CENARION_WARD = VUHDO_getSpellInfoSafe(429224);
...
VUHDO_SPELL_ID.PREMONITION_OF_SOLACE = VUHDO_getSpellInfoSafe(443526);
VUHDO_SPELL_ID.PRESCIENCE = VUHDO_getSpellInfoSafe(410089);
...
VUHDO_SPELL_ID.REMOVE_CURSE = VUHDO_getSpellInfoSafe(2782);
VUHDO_SPELL_ID.REMOVE_LESSER_CURSE = VUHDO_getSpellInfoSafe(475);
...
VUHDO_SPELL_ID.REVITALIZE = VUHDO_getSpellInfoSafe(450759);
...
VUHDO_SPELL_ID.SACRED_CLEANSING = VUHDO_getSpellInfoSafe(53551);
VUHDO_SPELL_ID.SACRED_SHIELD = VUHDO_getSpellInfoSafe(85285);
...
VUHDO_SPELL_ID.SPIRITBLOOM = VUHDO_getSpellInfoSafe(409895);
VUHDO_SPELL_ID.SPIRIT_SHELL = VUHDO_getSpellInfoSafe(114908);
...
VUHDO_SPELL_ID.SYMBIOSIS = VUHDO_getSpellInfoSafe(110309);
VUHDO_SPELL_ID.SYMBIOTIC_BLOOMS = VUHDO_getSpellInfoSafe(439530);
VUHDO_SPELL_ID.TAUNT = VUHDO_getSpellInfoSafe(355);
VUHDO_SPELL_ID.TEMPORAL_ANOMALY = VUHDO_getSpellInfoSafe(373862);
...
VUHDO_SPELL_ID.TYRS_DELIVERANCE = VUHDO_getSpellInfoSafe(200652);
...
VUHDO_SPELL_ID.INTERNAL_MEDICINE = VUHDO_getSpellInfoSafe(115451);
VUHDO_SPELL_ID.ENVELOPING_BREATH = VUHDO_getSpellInfoSafe(325209);
...
VUHDO_SPELL_ID.SERPENTS_ZEAL = VUHDO_getSpellInfoSafe(127722);


-- 3000 MASTERY (=>BOM)
VUHDO_SPELL_ID.GRACE_OF_AIR = VUHDO_getSpellInfoSafe(116956);
VUHDO_SPELL_ID.SPIRIT_BEAST_BLESSING = VUHDO_getSpellInfoSafe(128997);
VUHDO_SPELL_ID.ROAR_OF_COURAGE = VUHDO_getSpellInfoSafe(93435);

-- 5% Stats (=>BOK, Motw, LotE)
VUHDO_SPELL_ID.EMBRACE_OF_THE_SHALE_SPIDER = VUHDO_getSpellInfoSafe(90363);

-- 10% Stam (PWS, BloodPakt, Commanding shout)
VUHDO_SPELL_ID.QIRAJI_FORTITUDE = VUHDO_getSpellInfoSafe(90364);

-- 10% Spell Power (Arcane, Dalaran)
VUHDO_SPELL_ID.STILL_WATER = VUHDO_getSpellInfoSafe(126309);
VUHDO_SPELL_ID.BURNING_WRATH = VUHDO_getSpellInfoSafe(77747);
...
VUHDO_SPELL_ID.LEADER_OF_THE_PACK  = VUHDO_getSpellInfoSafe(17007);
VUHDO_SPELL_ID.TERRIFYING_ROAR  = VUHDO_getSpellInfoSafe(90309);
--still water
VUHDO_SPELL_ID.FURIOUS_HOWL  = VUHDO_getSpellInfoSafe(24604);
--arcane brilliance
...
VUHDO_SPELL_ID.BUFF_FEAR_WARD                   = VUHDO_getSpellInfoSafe(6346);
...
VUHDO_SPELL_ID.BUFF_INNER_FIRE                  = VUHDO_getSpellInfoSafe(588);
VUHDO_SPELL_ID.BUFF_INNER_WILL                  = VUHDO_getSpellInfoSafe(73413);
VUHDO_SPELL_ID.BUFF_SHADOWFIEND                 = VUHDO_getSpellInfoSafe(34433);


-- Shaman
-- Fire
VUHDO_SPELL_ID.BUFF_FIRE_ELEMENTAL_TOTEM   = VUHDO_getSpellInfoSafe(2894);
VUHDO_SPELL_ID.BUFF_MAGMA_TOTEM            = VUHDO_getSpellInfoSafe(8190);
VUHDO_SPELL_ID.BUFF_SEARING_TOTEM          = VUHDO_getSpellInfoSafe(3599);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_TOTEM      = VUHDO_getSpellInfoSafe(8227);
VUHDO_SPELL_ID.BUFF_TOTEM_OF_WRATH         = VUHDO_getSpellInfoSafe(57658);
-- Air
VUHDO_SPELL_ID.BUFF_GROUNDING_TOTEM         = VUHDO_getSpellInfoSafe(8177);
VUHDO_SPELL_ID.BUFF_WINDFURY                = VUHDO_getSpellInfoSafe(8512);
VUHDO_SPELL_ID.BUFF_WRATH_OF_AIR            = VUHDO_getSpellInfoSafe(3738);
VUHDO_SPELL_ID.BUFF_SOUL_LINK_TOTEM         = VUHDO_getSpellInfoSafe(98008);
-- Earth
VUHDO_SPELL_ID.BUFF_EARTHBIND_TOTEM       = VUHDO_getSpellInfoSafe(2484);
VUHDO_SPELL_ID.BUFF_EARTH_ELEMENTAL_TOTEM = VUHDO_getSpellInfoSafe(2062);
VUHDO_SPELL_ID.BUFF_TREMOR_TOTEM          = VUHDO_getSpellInfoSafe(8143);
VUHDO_SPELL_ID.BUFF_STRENGTH_OF_EARTH     = VUHDO_getSpellInfoSafe(8075);
VUHDO_SPELL_ID.BUFF_STONECLAW_TOTEM       = VUHDO_getSpellInfoSafe(5730);
VUHDO_SPELL_ID.BUFF_STONESKIN_TOTEM       = VUHDO_getSpellInfoSafe(8071);
-- Water
VUHDO_SPELL_ID.BUFF_HEALING_STREAM_TOTEM       = VUHDO_getSpellInfoSafe(5394);
VUHDO_SPELL_ID.BUFF_MANA_TIDE_TOTEM            = VUHDO_getSpellInfoSafe(16190);
VUHDO_SPELL_ID.BUFF_MANA_SPRING_TOTEM          = VUHDO_getSpellInfoSafe(5675);
VUHDO_SPELL_ID.BUFF_TOTEM_OF_TRANQUIL_MIND     = VUHDO_getSpellInfoSafe(87718);
VUHDO_SPELL_ID.BUFF_ELEMENTAL_RESISTANCE_TOTEM = VUHDO_getSpellInfoSafe(8184);

-- Weapon Enchants
VUHDO_SPELL_ID.BUFF_ROCKBITER_WEAPON   = VUHDO_getSpellInfoSafe(8017);
VUHDO_SPELL_ID.BUFF_WINDFURY_WEAPON    = VUHDO_getSpellInfoSafe(8232);
VUHDO_SPELL_ID.BUFF_FLAMETONGUE_WEAPON = VUHDO_getSpellInfoSafe(8024);
VUHDO_SPELL_ID.BUFF_FROSTBRAND_WEAPON  = VUHDO_getSpellInfoSafe(8033);
VUHDO_SPELL_ID.BUFF_EARTHLIVING_WEAPON = VUHDO_getSpellInfoSafe(51730);

VUHDO_SPELL_ID.BUFF_HEROISM = VUHDO_getSpellInfoSafe(32182);
VUHDO_SPELL_ID.BUFF_BLOODLUST = VUHDO_getSpellInfoSafe(2825);
VUHDO_SPELL_ID.BUFF_EARTH_SHIELD = VUHDO_getSpellInfoSafe(974);
VUHDO_SPELL_ID.BUFF_LIGHTNING_SHIELD = VUHDO_getSpellInfoSafe(324);
VUHDO_SPELL_ID.BUFF_WATER_SHIELD = VUHDO_getSpellInfoSafe(52127);
VUHDO_SPELL_ID.BUFF_NATURES_SWIFTNESS = VUHDO_getSpellInfoSafe(16188);
...
VUHDO_SPELL_ID.BUFF_BLESSING_OF_THE_KINGS = VUHDO_getSpellInfoSafe(20217);
VUHDO_SPELL_ID.BUFF_BLESSING_OF_MIGHT = VUHDO_getSpellInfoSafe(19740);
VUHDO_SPELL_ID.BUFF_RIGHTEOUS_FURY = VUHDO_getSpellInfoSafe(25780);
VUHDO_SPELL_ID.BUFF_DEVOTION_AURA = VUHDO_getSpellInfoSafe(465);
VUHDO_SPELL_ID.BUFF_RETRIBUTION_AURA = VUHDO_getSpellInfoSafe(7294);
VUHDO_SPELL_ID.BUFF_CONCENTRATION_AURA = VUHDO_getSpellInfoSafe(19746);
VUHDO_SPELL_ID.BUFF_RESISTANCE_AURA = VUHDO_getSpellInfoSafe(19726);
VUHDO_SPELL_ID.BUFF_CRUSADER_AURA = VUHDO_getSpellInfoSafe(32223);
VUHDO_SPELL_ID.BUFF_SEAL_OF_JUSTICE = VUHDO_getSpellInfoSafe(20164);
VUHDO_SPELL_ID.BUFF_SEAL_OF_INSIGHT = VUHDO_getSpellInfoSafe(20165);
VUHDO_SPELL_ID.BUFF_SEAL_OF_TRUTH = VUHDO_getSpellInfoSafe(31801);
VUHDO_SPELL_ID.BUFF_SEAL_OF_RIGHTEOUSNESS = VUHDO_getSpellInfoSafe(20154);
VUHDO_SPELL_ID.BUFF_INQUISITION = VUHDO_getSpellInfoSafe(84963);


-- Druid
VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD = VUHDO_getSpellInfoSafe(1126);
VUHDO_SPELL_ID.BUFF_THORNS           = VUHDO_getSpellInfoSafe(467);


-- Warlock
VUHDO_SPELL_ID.BUFF_DEMON_ARMOR = VUHDO_getSpellInfoSafe(687);
VUHDO_SPELL_ID.BUFF_FEL_ARMOR = VUHDO_getSpellInfoSafe(28176);
VUHDO_SPELL_ID.BUFF_DARK_INTENT = VUHDO_getSpellInfoSafe(85767);
VUHDO_SPELL_ID.BUFF_SOUL_LINK = VUHDO_getSpellInfoSafe(19028);
VUHDO_SPELL_ID.BUFF_GRIMOIR_OF_SACRIFICE = VUHDO_getSpellInfoSafe(108503);
...
VUHDO_SPELL_ID.BUFF_MAGE_ARMOR         = VUHDO_getSpellInfoSafe(6117);
VUHDO_SPELL_ID.BUFF_MOLTEN_ARMOR       = VUHDO_getSpellInfoSafe(30482);
VUHDO_SPELL_ID.BUFF_FROST_ARMOR        = VUHDO_getSpellInfoSafe(7302);
VUHDO_SPELL_ID.BUFF_ICE_ARMOR          = VUHDO_getSpellInfoSafe(1214);
VUHDO_SPELL_ID.BUFF_DALARAN_BRILLIANCE = VUHDO_getSpellInfoSafe(61316);
VUHDO_SPELL_ID.BUFF_FOCUS_MAGIC        = VUHDO_getSpellInfoSafe(54646);
VUHDO_SPELL_ID.BUFF_COMBUSTION         = VUHDO_getSpellInfoSafe(11129);


-- Death Knight
VUHDO_SPELL_ID.BUFF_HORN_OF_WINTER  = VUHDO_getSpellInfoSafe(57330);
VUHDO_SPELL_ID.BUFF_BONE_SHIELD     = VUHDO_getSpellInfoSafe(49222);
VUHDO_SPELL_ID.BUFF_BLOOD_PRESENCE  = VUHDO_getSpellInfoSafe(48263);
VUHDO_SPELL_ID.BUFF_FROST_PRESENCE  = VUHDO_getSpellInfoSafe(48266);
VUHDO_SPELL_ID.BUFF_UNHOLY_PRESENCE = VUHDO_getSpellInfoSafe(48265);
VUHDO_SPELL_ID.BUFF_UNHOLY_FRENZY   = VUHDO_getSpellInfoSafe(49016);


-- Warrior
VUHDO_SPELL_ID.BUFF_BATTLE_SHOUT     = VUHDO_getSpellInfoSafe(6673);
VUHDO_SPELL_ID.BUFF_COMMANDING_SHOUT = VUHDO_getSpellInfoSafe(469);
VUHDO_SPELL_ID.BUFF_VIGILANCE        = VUHDO_getSpellInfoSafe(50720);


-- Hunter
VUHDO_SPELL_ID.BUFF_TRUESHOT_AURA = VUHDO_getSpellInfoSafe(19506);
VUHDO_SPELL_ID.BUFF_ASPECT_OF_THE_HAWK = VUHDO_getSpellInfoSafe(13165);
VUHDO_SPELL_ID.BUFF_ASPECT_OF_THE_PACK = VUHDO_getSpellInfoSafe(13159);
VUHDO_SPELL_ID.BUFF_ASPECT_OF_THE_WILD = VUHDO_getSpellInfoSafe(20043);
...
-- Monk
VUHDO_SPELL_ID.BUFF_STANCE_OF_THE_FIERCE_TIGER = VUHDO_getSpellInfoSafe(103985);
VUHDO_SPELL_ID.BUFF_STANCE_OF_THE_STURDY_OX = VUHDO_getSpellInfoSafe(115069);
VUHDO_SPELL_ID.BUFF_STANCE_OF_THE_WISE_SERPENT = VUHDO_getSpellInfoSafe(115070);
VUHDO_SPELL_ID.BUFF_LEGACY_OF_THE_EMPEROR = VUHDO_getSpellInfoSafe(115921);
VUHDO_SPELL_ID.BUFF_LEGACY_OF_THE_WHITE_TIGER = VUHDO_getSpellInfoSafe(116781);
...
VUHDO_SPELL_ID.BUFF_SENSE_POWER = VUHDO_getSpellInfoSafe(361021);
...
VUHDO_NAME_TO_SPELL = {
	...
	[VUHDO_SPELL_ID.HOLY_WORD_SERENITY] = VUHDO_SPELL_ID.HOLY_WORD_CHASTISE,
