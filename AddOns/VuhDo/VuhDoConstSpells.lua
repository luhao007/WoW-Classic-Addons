...
VUHDO_SPELL_ID.BUFF_GREATER_BLESSING_OF_SANCTUARY = VUHDO_getSpellInfo(27169);
...
VUHDO_NAME_TO_SPELL = {
	...
	["Guérison de l'ombre"] = VUHDO_SPELL_ID.FLASH_HEAL, -- see: https://wow.curseforge.com/projects/vuhdo/issues/964
