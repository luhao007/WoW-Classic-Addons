...
VUHDO_SPELL_ID.BUFF_WINDFURY          = VUHDO_getSpellInfo(10613);
VUHDO_SPELL_ID.BUFF_GRACE_OF_AIR      = VUHDO_getSpellInfo(10627);
...
VUHDO_SPELL_ID.BUFF_STRENGTH_OF_EARTH     = VUHDO_getSpellInfo(8160);
-- Water
