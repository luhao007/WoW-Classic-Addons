...
VUHDO_MIN_TOC_VERSION = 50500;
VUHDO_MAX_TOC_VERSION = 60000;
...
-- Shaman
	...
	[VUHDO_SPELL_ID.BUFF_WATER_SHIELD] = true,
-- Paladin
	[VUHDO_SPELL_ID.BUFF_BEACON_OF_LIGHT] = true,
	[VUHDO_SPELL_ID.ETERNAL_FLAME] = true,
	[VUHDO_SPELL_ID.ILLUMINATED_HEALING] = true,
-- Hunter
...
-- Monk
	...
	[VUHDO_SPELL_ID.ZEN_SPHERE] = true,
	[VUHDO_SPELL_ID.SERPENTS_ZEAL] = true,
-- Evoker
};
