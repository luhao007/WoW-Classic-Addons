...
local GROUP_INT = {
	...
	VUHDO_SPELL_ID.BUFF_DALARAN_INTELLECT,
...
VUHDO_CLASS_BUFFS = {
	...
	["PALADIN"] = {
		...
		[VUHDO_SPELL_ID.BUFF_SACRED_SHIELD] = {
			{ VUHDO_SPELL_ID.BUFF_SACRED_SHIELD, VUHDO_BUFF_TARGET_UNIQUE },
		},
	},
	...
	["MAGE"] = {
		[VUHDO_SPELL_ID.BUFF_ARCANE_BRILLIANCE] = {
			...
			{ VUHDO_SPELL_ID.BUFF_DALARAN_INTELLECT, VUHDO_BUFF_TARGET_SINGLE, GROUP_INT },
