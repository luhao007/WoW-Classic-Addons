--[[
	...
	Revision: $Id: BeanCounterTidyUp.lua 6381 2019-08-29 20:52:32Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterTidyUp.lua $","$Rev: 6381 $","5.1.DEV.", 'auctioneer', 'libs')
