--[[
	...
	Revision: $Id: EnxMain.lua 6392 2019-08-29 20:52:32Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxMain.lua $", "$Rev: 6392 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Rev: 6392 $")
