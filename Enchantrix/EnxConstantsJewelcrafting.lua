--[[
	...
	Revision: $Id: EnxConstantsJewelcrafting.lua 6392 2019-08-29 20:52:32Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxConstantsJewelcrafting.lua $", "$Rev: 6392 $")
...
-- TODO - ccox - get yield information!
-- first pass/guess is duplicating pattern from Legion

	[MONELITE_ORE] = {
			[GEM_KRAKENSEYE] = 0.001,
		
			[GEM_GOLDENBERYL] = 0.05,
			[GEM_RUBELIGHT] = 0.05,
			[GEM_KUBILINE] = 0.05,
			[GEM_SOLSTONE] = 0.05,
			[GEM_VIRIDIUM] = 0.05,
			...
			[GEM_OWLSEYE] = 0.011,
			[GEM_SCARLETDIAMOND] = 0.011,
			[GEM_TIDALAMYTHEST] = 0.011,
			[GEM_AMBERBLAZE] = 0.011,
			[GEM_LARIBOLE] = 0.011,
			[GEM_ROYALQUARTZ] = 0.011,
	},
