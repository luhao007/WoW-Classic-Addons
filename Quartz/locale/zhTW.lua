...
L["Height"] = "高度"
L["Hide Blizz Mirror Bars"] = "隱藏 Blizzard 環境對應計時條"
...
L["Set the color of the casting bar spark"] = "設定施放條的亮點顏色"
...
L["Tweak the horizontal position of the bars for your %s"] = "調整你的 %s 計時條的水平位置"
L["Tweak the space between bars"] = "調整條列間距"
L["Tweak the space between bars for your %s"] = "調整你的 %s 計時條之間的距離"
L["Tweak the vertical position of the bars"] = "調整條列的垂直位置"
L["Tweak the vertical position of the bars for your %s"] = "調整你的 %s 計時條的垂直位置"
L["Tweak the vertical position of thebars"] = "調整條列的垂直位置"
